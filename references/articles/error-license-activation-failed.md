---
title: "Why do I get the 'License Activation Failed. There was a problem communicating with the server.' error? - Affinity Help Center"
source: https://www.affinity.studio/help/error-license-activation-failed/
slug: error-license-activation-failed
fetched: 2026-08-06
---

# Why do I get the "License Activation Failed. There was a problem communicating with the server." error? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/error-license-activation-failed/

[Skip to main content](https://www.affinity.studio/help/error-license-activation-failed/#_r_0_)
...
2.   ... 
3.   Why do I get the "License Activation Failed. There was a problem communicating with the server." error? 

# Why do I get the "License Activation Failed. There was a problem communicating with the server." error?

If you receive the error "There was a problem communicating with the server" when attempting to log into Affinity, it typically indicates that a firewall or proxy is preventing the application from connecting to the internet.

To resolve this, please add the following URLs to your firewall/proxy whitelist. Additionally, connecting via a VPN may also contribute to these types of connection problems.

*   [https://affinity.studio](https://affinity.studio/)
*   [https://affin.co/](https://affin.co/)
*   [https://www.canva.com](https://www.canva.com/)
*   [https://canva.com](https://canva.com/)
*   [https://api.canva.com/](https://api.canva.com/)
*   [https://serifservices.com](https://serifservices.com/)
*   [http://api.serifservices.com](http://api.serifservices.com/)
*   [https://affinity.api.serifservices.com](https://affinity.api.serifservices.com/)
*   [https://page.service.serif.com](https://page.service.serif.com/)
*   [https://seriflabs.com](https://seriflabs.com/)
