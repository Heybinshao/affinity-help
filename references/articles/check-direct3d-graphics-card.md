---
title: "How to check your graphics card supports Direct3D 12 (feature level 12.0) - Affinity Help Center"
source: https://www.affinity.studio/help/check-direct3d-graphics-card/
slug: check-direct3d-graphics-card
fetched: 2026-08-06
---

# How to check your graphics card supports Direct3D 12 (feature level 12.0) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/check-direct3d-graphics-card/

[Skip to main content](https://www.affinity.studio/help/check-direct3d-graphics-card/#_r_0_)
...
3.   How to check your graphics card supports Direct3D 12 (feature level 12.0)

# How to check your graphics card supports Direct3D 12 (feature level 12.0)

To determine if your graphics card supports Direct3D 12 Feature Level 12.0, which is necessary for Hardware Acceleration in Affinity, follow these steps:

1.   Press the**Windows Key** + **R**
2.   Type "**dxdiag**" into the **Run** dialog and press **OK**

This will open the DirectX Diagnostic Tool. Navigate to the **Display** tab and locate **Feature Levels** under the **Drivers** section. This will indicate the feature levels supported by your graphics card. If **12_0** or higher is listed, your card supports Direct3D 12 Feature Level 12.0.

**Note:** If you have multiple displays, there will be multiple **Display** tabs. Ensure you select the correct tab to view details for any dedicated graphics card installed or connected
