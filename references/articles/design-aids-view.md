---
title: "Document views - Affinity Help Center"
source: https://www.affinity.studio/help/design-aids-view/
slug: design-aids-view
fetched: 2026-08-06
---

# Document views - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/design-aids-view/

[Skip to main content](https://www.affinity.studio/help/design-aids-view/#_r_0_)
...
Different views of the same document let you view a design at different zoom levels simultaneously.

This can be achieved by opening your current document in a New View. The views can then be set to different zoom levels. Changes made to any view are replicated in the other.

[](https://www.affinity.studio/help/design-aids-view/#how-to-open-the-current-document-in-a-new-view)

### How to open the current document in a new view

Desktop app

*   On the **View** menu, select **New View**. The document opens in a new tab/window which includes a numerical reference in its title.

[](https://www.affinity.studio/help/design-aids-view/#how-to-switch-between-open-documents-and-views)

### How to switch between open documents and views
...
*   On the **View** menu, select a document from the **Views** submenu.

[](https://www.affinity.studio/help/design-aids-view/#see-also:)

#### SEE ALSO:

*   [App and document windows](https://www.affinity.studio/help/workspace-appdoc-windows/)
