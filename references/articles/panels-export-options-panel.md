---
title: "Export Options panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-export-options-panel/
slug: panels-export-options-panel
fetched: 2026-08-06
---

# Export Options panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-export-options-panel/

[Skip to main content](https://www.affinity.studio/help/panels-export-options-panel/#_r_0_)
...
[](https://www.affinity.studio/help/panels-export-options-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **General > Export Options**.

Once an export area has been defined, the Export Options panel allows you to set specific export attributes for that area. Using the panel, different export areas on the page can have different settings applied. This gives you full control over your exported projects.

You can save custom settings as a preset for future use.

[](https://www.affinity.studio/help/panels-export-options-panel/#options)

## Options

Your choice of file format (or preset, which includes a file format) determines which other settings are shown on the panel.

For descriptions of the complete range of settings and their availability by format, see [Export settings](https://www.affinity.studio/help/sharing-export-settings/).
...
*   **Create / Rename / Delete Preset**—allows you to manage your commonly used export settings.
...
[](https://www.affinity.studio/help/panels-export-options-panel/#see-also:)

#### SEE ALSO:

*   [Exporting using the Slice Studio](https://www.affinity.studio/help/sharing-slice-studio/)
*   [Slices panel](https://www.affinity.studio/help/panels-slices-panel/)
