---
title: "Measure Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-measure/
slug: tools-tools-measure
fetched: 2026-08-06
---

# Measure Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-measure/

[Skip to main content](https://www.affinity.studio/help/tools-tools-measure/#_r_0_)
...
![Image 4](https://images.ctfassets.net/3p2fxa94bzao/5G4aSAqWxQc7gzG6pHdlra/905d275cb568cf9e82f95e7927bde86e/measure_tool.svg)

 lets you measure the distance between objects, between an object and a page element (e.g., a placed guide, the page center or the page edge) or between guides. This can be done vertically, horizontally or diagonally.

[](https://www.affinity.studio/help/tools-tools-measure/#where-to-find-it)

### Where to find it

The Measure Tool is available in Vector Studio.

It can be added to other Studios. See 'Customizing tools' for details.

The tool also lets you scale your document or the currently selected artboard by either setting a scale factor (e.g., 1:100, 1cm:1km) or by scaling to a known distance (e.g., 10 meters) based on the object dimension currently being measured.

Measurements are not permanently displayed, are non-printable and are not saved with your document.

[](https://www.affinity.studio/help/tools-tools-measure/#options)
...
*   **Drawing Scale**—sets the drawing scale for the document or currently selected artboard. By default, all measurements are made using this scale setting.
*   **Assign Drawing Scale**—with a current measurement in place, click to enter a 'real world' dimension from which the drawing scale will be automatically calculated.

[](https://www.affinity.studio/help/tools-tools-measure/#shortcuts)

## Shortcuts

Desktop app

The Measure Tool has no keyboard shortcut by default, but one can be assigned via the app's settings.

[](https://www.affinity.studio/help/tools-tools-measure/#see-also:)

#### SEE ALSO:

*   [Measuring](https://www.affinity.studio/help/design-aids-measuring/)
