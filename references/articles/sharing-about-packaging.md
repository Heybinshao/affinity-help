---
title: "About packaging - Affinity Help Center"
source: https://www.affinity.studio/help/sharing-about-packaging/
slug: sharing-about-packaging
fetched: 2026-08-06
---

# About packaging - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/sharing-about-packaging/

[Skip to main content](https://www.affinity.studio/help/sharing-about-packaging/#_r_0_)
...
[](https://www.affinity.studio/help/sharing-about-packaging/#a-package-s-contents)

## A package's contents

Packaging a document outputs a copy of it and any fonts and linked images it uses into a folder.

When packaging is complete, the destination folder will contain:

*   Your Affinity document, with the file extension .afpackage.
*   A folder named _Fonts_ containing available fonts used by your document.
*   A folder named _Images_ containing available images linked from your document.
*   A folder named _Texts_ containing available text files linked from your document.
...
With everything copied to a folder, you can share the package with others using your preferred method, such as cloud storage. Before doing so, review your licensing terms for all items in the package.

[](https://www.affinity.studio/help/sharing-about-packaging/#differences-between-save-as-package-and-collect)

## Differences between Save As Package and Collect

In Affinity for desktop, the Resource Manager's **Collect** feature may sound similar to Save As Package. However, it is designed to collate some or all of a document's linked resources in a folder. It updates the document to reference the resources' new location. Also, it does not process fonts.

[](https://www.affinity.studio/help/sharing-about-packaging/#see-also:)
...
*   [Resaving modified packages](https://www.affinity.studio/help/sharing-resaving-packages/)
