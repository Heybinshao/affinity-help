---
title: "Machine Learning system requirements - Affinity Help Center"
source: https://www.affinity.studio/help/machine-learning-system-requirements/
slug: machine-learning-system-requirements
fetched: 2026-08-06
---

# Machine Learning system requirements - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/machine-learning-system-requirements/

[Skip to main content](https://www.affinity.studio/help/machine-learning-system-requirements/#_r_0_)
...
3.   Machine Learning system requirements

# Machine Learning system requirements

The optional Affinity Machine Learning features (Object Selection Tool, Select Subject, Portrait Blur, Select Sampled Depth, Colorize, and Super-Resolve Document) require a downloaded pre-trained model. Your data remains on your device and is not used for further training. Please refer to the system requirements below.

**ML system requirements:**

*   For Mac: Apple M Series chip only; macOS Ventura 13 or later.
*   For Windows: x64 or ARM64; 10 and 11.

Machine Learning features are not supported on Intel-based Macs. Consequently, the Machine Learning Models tab will not appear in Affinity’s Settings window.
