---
title: "Brush panel (Liquify Studio) - Affinity Help Center"
source: https://www.affinity.studio/help/panels-liquify-panel-brush/
slug: panels-liquify-panel-brush
fetched: 2026-08-06
---

# Brush panel (Liquify Studio) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-liquify-panel-brush/

[Skip to main content](https://www.affinity.studio/help/panels-liquify-panel-brush/#_r_0_)
...
3.   Brush panel (Liquify Studio)

# Brush panel (Liquify Studio)

The Brush panel allows you to control the settings for the Liquify tools.

This feature is only available in Affinity for desktop.

[](https://www.affinity.studio/help/panels-liquify-panel-brush/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **Brush**.

[](https://www.affinity.studio/help/panels-liquify-panel-brush/#options)
...
*   **Size**—the brush (stroke) size in pixels. Type directly in the text box or drag the slider to set the value.
*   **Hardness**—how hard the edges of the brush are. The brush appears softer as the percentage decreases. Type directly in the text box or drag the slider to set the value.
*   **Opacity**—the strength of the effect applied with each stroke. Type directly in the text box or drag the slider to set the value.
*   **Speed**—how fast the brush effect is applied (1% is very slow, 100% is immediate). Type directly in the text box or drag the slider to set the value.
*   **Ramp**—determines the shape at the edge of the brush (and therefore the shape of the mesh after a stroke has been applied). Select from the pop-up menu.
...
[](https://www.affinity.studio/help/panels-liquify-panel-brush/#see-also:)
...
*   [Customising Studios](https://www.affinity.studio/help/workspace-customizing-studios/)
