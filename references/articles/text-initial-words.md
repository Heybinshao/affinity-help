---
title: "Initial words - Affinity Help Center"
source: https://www.affinity.studio/help/text-initial-words/
slug: text-initial-words
fetched: 2026-08-06
---

# Initial words - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/text-initial-words/

[Skip to main content](https://www.affinity.studio/help/text-initial-words/#_r_0_)
...
Unique formatting can be applied to the first few words of a paragraph.

You can choose which character style is applied to initial words. You can also control the maximum number of words that are formatted, and specify characters that will end the special formatting, if encountered.

![Image 4: Initial words](https://images.ctfassets.net/3p2fxa94bzao/4PK7KQiAxRdtN83accll9H/d12fbee99f49c623ba78eb04e04f4a84/initialwords.png)

Initial words set to end after two words or a comma, whichever is reached first.

[](https://www.affinity.studio/help/text-initial-words/#how-to-apply-initial-words-as-local-formatting)

### How to apply initial words as local formatting

Desktop app

1.   Create an insertion point or select a range of text in the paragraph you wish to affect.
2.    On the **Paragraph** panel's **Initial Words** section: 
    1.   Check **Enabled**.
    2.   Set **Max word count** to the maximum number of words that will be styled.
    3.   Specify any **End characters** that, if encountered before the maximum word count is reached, will automatically end initial word formatting.
    4.   Set **Style** to the character style for the initial words.

The same settings are available when editing a text style. On the dialog's **Paragraph** section, select **Initial Words**.

[](https://www.affinity.studio/help/text-initial-words/#see-also:)

#### SEE ALSO:

*   [Paragraph panel](https://www.affinity.studio/help/panels-paragraph-panel/)
*   [Paragraph formatting](https://www.affinity.studio/help/text-paragraphs/)
