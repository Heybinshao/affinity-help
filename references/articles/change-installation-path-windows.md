---
title: "Change the installation location for the MSIX version of Affinity on Windows - Affinity Help Center"
source: https://www.affinity.studio/help/change-installation-path-windows/
slug: change-installation-path-windows
fetched: 2026-08-06
---

# Change the installation location for the MSIX version of Affinity on Windows - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/change-installation-path-windows/

[Skip to main content](https://www.affinity.studio/help/change-installation-path-windows/#_r_0_)
...
3.   Change the installation location for the MSIX version of Affinity on Windows

# Change the installation location for the MSIX version of Affinity on Windows

When installing the MSIX version of Affinity for Windows, you won't be able to change the installation path. This is standard for MSIX packages; all Windows apps are installed to the default drive configured in **Settings**>**System**>**Storage**.

[](https://www.affinity.studio/help/change-installation-path-windows/#you-have-two-choices-for-altering-the-installation-location-of-affinity:)

## You have two choices for altering the installation location of Affinity:

[](https://www.affinity.studio/help/change-installation-path-windows/#alter-the-installation-location-of-affinity:-windows-10)

### Alter the installation location of Affinity: Windows 10
...
2.   Select the required drive from the **New apps will save to**: dropdown menu
3.   Once you've installed the app to the new drive, you can revert this setting back to**Local Disk (C:)**

**After Installation:**

1.   Go to **Settings**>**Apps**>**Installed Apps.**
2.   Select **Affinity** from the list.
3.   Select **Move.**

[](https://www.affinity.studio/help/change-installation-path-windows/#alter-the-installation-location-of-affinity:-windows-11)

### Alter the installation location of Affinity: Windows 11
...
1.   Go to **Settings**>**Apps**>**Installed apps.**
2.   Select the**three dots** next to **Affinity**.
3.   Select **Move.**
