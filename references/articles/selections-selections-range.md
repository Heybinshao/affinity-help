---
title: "Range pixel selections - Affinity Help Center"
source: https://www.affinity.studio/help/selections-selections-range/
slug: selections-selections-range
fetched: 2026-08-06
---

# Range pixel selections - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/selections-selections-range/

[Skip to main content](https://www.affinity.studio/help/selections-selections-range/#_r_0_)
...
3.   Range pixel selections

# Range pixel selections

You can create pixel selections using color, tonal or transparency (alpha/opacity) ranges from your image.

![Image 4: Range-based pixel selection](https://images.ctfassets.net/3p2fxa94bzao/5jX0EUTVDgCLgyFAJboeqq/2a67cefd07dc9e39fee3c47ee6955690/range_pixel_selections.jpg)
...
Color, tonal and transparency range selections are available from the **Pixel > Pixel Selection** menu and include:

*    On the **Color Range** submenu: 
    *   **Select Reds**
    *   **Select Blues**
    *   **Select Greens**

*    On the **Tonal Range** submenu: 
    *   **Select Midtones**
    *   **Select Shadows**
    *   **Select Highlights**

*    On the **Alpha Range** submenu: 
...
Try creating range pixel selections before applying an adjustment layer. This allows you to target the adjustment directly to any one of the Color or Tonal ranges.

[](https://www.affinity.studio/help/selections-selections-range/#see-also:)
...
*   [Sampled Depth pixel selections](https://www.affinity.studio/help/selections-selections-sampled-depth/)
