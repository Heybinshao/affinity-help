---
title: "Save a copy of the Application logs from the Windows Event Viewer - Affinity Help Center"
source: https://www.affinity.studio/help/windows-event-viewer-application-logs/
slug: windows-event-viewer-application-logs
fetched: 2026-08-06
---

# Save a copy of the Application logs from the Windows Event Viewer - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/windows-event-viewer-application-logs/

[Skip to main content](https://www.affinity.studio/help/windows-event-viewer-application-logs/#_r_0_)
...
3.   Save a copy of the Application logs from the Windows Event Viewer

# Save a copy of the Application logs from the Windows Event Viewer

When the Affinity support team asks for your Application Logs from Event Viewer, or if you're trying to diagnose an application installation failure or crash, the Windows Event Viewer often contains helpful diagnostic details. These steps apply to Windows 10 and Windows 11.

[](https://www.affinity.studio/help/windows-event-viewer-application-logs/#how-to-save-your-application-and-system-logs)

### How to save your Application and System logs

Windows app

1.   Open the Start menu, type **Event Viewer**, and press the **Enter** key.
2.   In the left panel, expand **Windows Logs**.
3.   Select **Application**.
4.   On the **Actions** panel on the right, click **Save All Events As**. 
5.   Choose a save location (such as your Desktop), give the file a name, and ensure the file type is set to **Event Files (*.evtx)**.
6.   Click **Save**. When prompted, select **English** under **Display Information**—this ensures the Affinity support team can read the log file—then click **OK**.
7.   Nothing showing up? If the Application log contains no Affinity-related entries, check the System log—some crash events are recorded there instead. Repeat steps 3–6 for **System** (also listed under Windows Logs).

Attach the .evtx file to your email reply to our support team or include it when submitting a new ticket through the Affinity Help Centre.
