---
title: "Special characters and glyphs - Affinity Help Center"
source: https://www.affinity.studio/help/text-special-characters/
slug: text-special-characters
fetched: 2026-08-06
---

# Special characters and glyphs - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/text-special-characters/

Glyphs can vary between fonts. If you apply a different font, some characters may appear as rectangles or disappear entirely. This means the font doesn't define glyphs for those characters.

[Skip to main content](https://www.affinity.studio/help/text-special-characters/#_r_0_)
...
You can insert characters/glyphs using the **Glyph Browser** panel, including Unicode characters and alternates.

Glyphs can vary between fonts. If you apply a different font, some characters may appear as rectangles or disappear entirely. This means the font doesn't define glyphs for those characters.

Some special characters are invisible. Affinity can highlight their positions in document text. See [Text marks](https://www.affinity.studio/help/text-text-marks/).

A selection of commonly used special characters can be inserted via the **Text** menu's **Insert** submenu. Options include non-breaking space, non-breaking hyphen, soft hyphen, and zero-width space.

[](https://www.affinity.studio/help/text-special-characters/#how-to-add-commonly-used-special-characters-glyphs)

### How to add commonly used special characters/glyphs
...
[](https://www.affinity.studio/help/text-special-characters/#how-to-insert-characters-using-the-glyph-browser-panel)

### How to insert characters using the Glyph Browser panel

Desktop app

1.   Create an insertion point in your text.
2.   On the **Window** menu, select **Text > Glyph Browser**.
3.   Select a font family, font style, and subset from the pop-up menus.
4.   Double-click a glyph to add it at the insertion point.

Emoji (and other special characters) can be inserted via:

*   For Mac: **Character Viewer**, which is accessed by selecting **Emoji & Symbols** on the **Edit** menu.
*   For Windows: **Emoji** panel, which is accessed by pressing Win+. (full stop).

[](https://www.affinity.studio/help/text-special-characters/#how-to-show-special-characters--paragraph-marks--spaces--and-breaks--in-text)

### How to show special characters (paragraph marks, spaces, and breaks) in text

Desktop app

*   On the **Text** menu, select **Show Special Characters**.

[](https://www.affinity.studio/help/text-special-characters/#see-also:)

#### SEE ALSO:

*   [Text marks](https://www.affinity.studio/help/text-text-marks/)
*   [Glyph Browser panel](https://www.affinity.studio/help/panels-glyph-panel/)
