---
title: "Rotate/flip the canvas - Affinity Help Center"
source: https://www.affinity.studio/help/size-transform-canvas-rotate-flip/
slug: size-transform-canvas-rotate-flip
fetched: 2026-08-06
---

# Rotate/flip the canvas - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/size-transform-canvas-rotate-flip/

[Skip to main content](https://www.affinity.studio/help/size-transform-canvas-rotate-flip/#_r_0_)
...
3.   Rotate/flip the canvas

# Rotate/flip the canvas

The canvas and its contents can be flipped and rotated permanently using the commands from the Document menu.

If you wish to temporarily rotate the canvas, viewing your content from a different angle without altering it, this can be done from the **View** menu or by using a Trackpad. See [Rotate document view](https://www.affinity.studio/help/design-aids-rotate-canvas/) for more information.

[](https://www.affinity.studio/help/size-transform-canvas-rotate-flip/#how-to-flip-the-canvas-horizontally)

### How to flip the canvas horizontally

Desktop app

*   On the **Document** menu, select **Flip Horizontal**.

[](https://www.affinity.studio/help/size-transform-canvas-rotate-flip/#how-to-flip-the-canvas-vertically)

### How to flip the canvas vertically

Desktop app

*   On the **Document** menu, select **Flip Vertical**.

[](https://www.affinity.studio/help/size-transform-canvas-rotate-flip/#how-to-rotate-the-canvas-90--counter-clockwise)

### How to rotate the canvas 90° counter-clockwise

Desktop app

*   On the **Document** menu, select **Rotate 90° Counter-clockwise**.

[](https://www.affinity.studio/help/size-transform-canvas-rotate-flip/#how-to-rotate-the-canvas-90--clockwise)

### How to rotate the canvas 90° Clockwise

Desktop app

*   On the **Document** menu, select **Rotate 90° Clockwise**.

[](https://www.affinity.studio/help/size-transform-canvas-rotate-flip/#see-also:)

#### SEE ALSO:

*   [Rotate document view](https://www.affinity.studio/help/design-aids-rotate-canvas/)
