---
title: "Information for Version 1 and Version 2 Users - Affinity Help Center"
source: https://www.affinity.studio/help/info-for-v1-and-v2-users/
slug: info-for-v1-and-v2-users
fetched: 2026-08-06
---

# Information for Version 1 and Version 2 Users - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/info-for-v1-and-v2-users/

[Skip to main content](https://www.affinity.studio/help/info-for-v1-and-v2-users/#_r_0_)
...
3.   Information for Version 1 and Version 2 Users

# Information for Version 1 and Version 2 Users

If you're an Affinity by Canva user (launched October 2025), and not an Affinity V1 and V2 user, this topic is not relevant to you.

If you’re using an earlier version of Affinity (V1 or V2), you can still access resources and account information for those versions using the links below.

*   [**Affinity V2 site:**](https://affinity.serif.com/v2/) Visit the Version 2 site for information about Affinity V1 and V2 apps.
*   [**Affinity Help Centre for V1 and V2:**](https://affinity.help/) Explore this comprehensive resource for Version 1 and Version 2 products, including main topics and reference topics for tools and panels.
*   [**Affinity accounts (V1 and V2):**](https://store.serif.com/) Sign in to your Serif account to manage purchases, [downloads](https://store.serif.com/en-gb/update/universal-licence/), and licences for Version 1 and Version 2 apps.
*   [**Affinity V1 and V2 Support Center**](https://support.serif.com/hc/): Search the knowledge base for quick answers.

Note that the Affinity Store is no longer available but you can still access your account and manage your existing add-ons via Accounts in your V1/V2 app.

All V1 and V2 apps can continue to be used in the future without restriction.
