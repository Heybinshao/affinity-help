---
title: "Liquify Push Left Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-liquify-push-left/
slug: tools-tools-liquify-push-left
fetched: 2026-08-06
---

# Liquify Push Left Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-liquify-push-left/

[Skip to main content](https://www.affinity.studio/help/tools-tools-liquify-push-left/#_r_0_)
...
2.   Liquify Push Left Tool

# Liquify Push Left Tool

The Liquify Push Left Tool

![Image 4](https://images.ctfassets.net/3p2fxa94bzao/7coh6pqNG77HluxAble7XF/e32007fb9041a5209c3850f8c5ed09a1/liquify_push_left_tool.svg)

 shifts pixels 90° to the left of the stroke direction. This spreads and compresses edges along the stroke.

[](https://www.affinity.studio/help/tools-tools-liquify-push-left/#where-to-find-it)

### Where to find it

The Liquify Push Left Tool is available only in **Liquify Studio**.

Tool shortcut key: **L**.

[](https://www.affinity.studio/help/tools-tools-liquify-push-left/#options)
...
[](https://www.affinity.studio/help/tools-tools-liquify-push-left/#shortcuts)
...
*   To achieve the opposite warp effect when using the tool, hold the **⌥** key (Mac) / **Alt** key (Windows).

[](https://www.affinity.studio/help/tools-tools-liquify-push-left/#see-also:)
