---
title: "Desktop settings: Home Screen - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-home-screen/
slug: desktop-settings-home-screen
fetched: 2026-08-06
---

# Desktop settings: Home Screen - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-home-screen/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-home-screen/#_r_0_)
...
2.   Desktop settings: Home Screen

# Desktop settings: Home Screen

Customize the contents of Affinity's Home screen.

The following settings are available:

*   **Show these items on Home**—Choose which sections appear on Affinity's Home Screen: **Recent Documents**, **Favorites**, **My Presets**, and **My Templates**.You can show or hide a section by checking or unchecking it. Drag sections up or down to reorder them; the order here matches the Home Screen.

The Learn section is always shown on the Home Screen and cannot be hidden.

[](https://www.affinity.studio/help/desktop-settings-home-screen/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-home-screen/#see-also:)

#### SEE ALSO:

*   [About Settings for desktop](https://www.affinity.studio/help/workspace-settings/)
*   [Settings: Tools](https://www.affinity.studio/help/desktop-settings-tools/)
