---
title: "Divide by Alpha filter - Affinity Help Center"
source: https://www.affinity.studio/help/filters-filter-divide-by-alpha/
slug: filters-filter-divide-by-alpha
fetched: 2026-08-06
---

# Divide by Alpha filter - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/filters-filter-divide-by-alpha/

[Skip to main content](https://www.affinity.studio/help/filters-filter-divide-by-alpha/#_r_0_)
...
2.   Divide by Alpha filter

# Divide by Alpha filter

The Divide by Alpha filter ensures the transparency in an image is stored using a non-premultiplied alpha representation.

After

Before

![Image 3: After](https://images.ctfassets.net/3p2fxa94bzao/2aaMdTOKQoc3ABfRMma0EQ/ea5f773f3ea63065cf3759e8c79b0d92/filter_dividebyalpha_after.jpg)

![Image 4: Before](https://images.ctfassets.net/3p2fxa94bzao/31kR5ANFdKNbUfDfsGAwWw/2042f6e4f769994d6881ead321b17e2a/filter_dividebyalpha_before.jpg)

[](https://www.affinity.studio/help/filters-filter-divide-by-alpha/#about-the-divide-by-alpha-filter)

## About the Divide by Alpha filter

If an image containing premultiplied alpha data (for use in other apps, such as compositing software and game engines) needs to be edited in Affinity, first apply the filter to convert the data to a non-premultiplied representation. Not doing so may result in outline/halo effects or edges being too dark.

After performing your editing tasks, apply the complementary Multiply by Alpha filter to convert back to a premultiplied alpha representation.
...
[](https://www.affinity.studio/help/filters-filter-divide-by-alpha/#see-also:)
