---
title: "Create a desktop shortcut for Affinity (MSIX Version) on Windows - Affinity Help Center"
source: https://www.affinity.studio/help/create-desktop-shortcut-windows/
slug: create-desktop-shortcut-windows
fetched: 2026-08-06
---

# Create a desktop shortcut for Affinity (MSIX Version) on Windows - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/create-desktop-shortcut-windows/

[Skip to main content](https://www.affinity.studio/help/create-desktop-shortcut-windows/#_r_0_)
...
3.   Create a desktop shortcut for Affinity (MSIX Version) on Windows

# Create a desktop shortcut for Affinity (MSIX Version) on Windows

If you've installed the MSIX version of Affinity for Windows, you might notice that you weren't given the option to create a desktop shortcut. This is normal behavior and is due to the way MSIX packages function.

However, you can create a desktop shortcut manually after installation. To do this, go to **Start**>**Run**, enter "**Shell:AppsFolder**" and press **OK**.

This will open a folder where you can drag and drop a copy of the **Affinity** shortcut to your desktop.
