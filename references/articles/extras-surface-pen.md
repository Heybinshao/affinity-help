---
title: "Using Surface Pen (Windows) - Affinity Help Center"
source: https://www.affinity.studio/help/extras-surface-pen/
slug: extras-surface-pen
fetched: 2026-08-06
---

# Using Surface Pen (Windows) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/extras-surface-pen/

[Skip to main content](https://www.affinity.studio/help/extras-surface-pen/#_r_0_)
...
3.   Using Surface Pen (Windows)

# Using Surface Pen (Windows)

You can use a Microsoft Surface Pen to navigate Affinity's interface and to draw with its creative tools.

This feature is only available in Affinity for desktop.

[](https://www.affinity.studio/help/extras-surface-pen/#integration-with-affinity)

## Integration with Affinity

Pressure from Surface Pen controls brush size in Affinity. Tilt controls brush saturation.

Flip the Surface Pen to use its eraser. Affinity detects layer type and either masks vector shapes or erases pixels.

You don't have to switch Studios, create mask layers, or select the **Erase Brush Tool**—start erasing and Affinity handles the rest.

To ignore finger contact but still use Surface Pen input, enable **Touch for gestures only** in Affinity's settings.

[](https://www.affinity.studio/help/extras-surface-pen/#use-surface-pen-pressure-and-tilt-input)

### Use Surface Pen pressure and tilt input

Windows app

1.   On the **Brushes** panel, double-click a brush.
2.   On the dialog that appears: 
    1.   Select **Dynamics**.
    2.   Set **Size Jitter** to **Pressure** and adjust the amount and Ramp profile.
    3.   Set other attributes as required. For example, set **Saturation Jitter** to **Tilt** and adjust the amount and Ramp profile.

[](https://www.affinity.studio/help/extras-surface-pen/#see-also:)

#### SEE ALSO:

*   [Customizing Studios](https://www.affinity.studio/help/workspace-customizing-studios/)
*   [Using Surface Dial with your Affinity Windows apps](https://www.affinity.studio/help/extras-surface-dial/)
*   [Using pen tablets (Mac and Windows)](https://www.affinity.studio/help/extras-pen-tablet/)
