---
title: "Desktop settings: Auto-Correct, Abbreviations, Filler Text, and Title Exceptions - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-auto-correct-and-other-text/
slug: desktop-settings-auto-correct-and-other-text
fetched: 2026-08-06
---

# Desktop settings: Auto-Correct, Abbreviations, Filler Text, and Title Exceptions - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-auto-correct-and-other-text/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-auto-correct-and-other-text/#_r_0_)
...
2.   Desktop settings: Auto-Correct, Abbreviations, Filler Text, and Title Exceptions

# Desktop settings: Auto-Correct, Abbreviations, Filler Text, and Title Exceptions

Choose how Affinity handles typed text in the specific situations described below.The following settings are available:

*   **Auto-Correct**—Use these options to control how auto-correction intelligently and automatically replaces or formats your art and frame text.
*   **Abbreviations**—Use to provide a predefined abbreviations dictionary which is used to maintain correct capitalization when the abbreviation is used in text. This feature requires Auto-Correct to be enabled.
*   **Filler Text**—Instead of placeholder 'Latin' text, you can add your own custom text content for various languages to act as [filler text](https://www.affinity.studio/help/Text/fillerText.html).
*   **Title Exceptions**—Use to control the case sensitivity of specific words by keeping a title exception list to override standard capitalization behavior.

Capitalization of abbreviations may still be affected at the start of sentences if **Capitalize first letter of sentences**is enabled in Auto-Correct settings.)

[](https://www.affinity.studio/help/desktop-settings-auto-correct-and-other-text/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-auto-correct-and-other-text/#see-also:)

#### SEE ALSO:

*   [Filler text](https://www.affinity.studio/help/text-filler-text/)
*   [About Settings for desktop](https://www.affinity.studio/help/workspace-settings/)
*   [Settings: Linked Services](https://www.affinity.studio/help/desktop-settings-linked-services/)
