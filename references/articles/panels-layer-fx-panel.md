---
title: "Quick FX panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-layer-fx-panel/
slug: panels-layer-fx-panel
fetched: 2026-08-06
---

# Quick FX panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-layer-fx-panel/

[Skip to main content](https://www.affinity.studio/help/panels-layer-fx-panel/#_r_0_)
...
[](https://www.affinity.studio/help/panels-layer-fx-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **Vector > Quick FX**.

[](https://www.affinity.studio/help/panels-layer-fx-panel/#about-layer-effects)

## About layer effects

Layer effects can be applied to the currently selected object or entire layer. These effects are non-destructive, so you can change them any time.

[](https://www.affinity.studio/help/panels-layer-fx-panel/#options)
...
*   **3D**—adds directional lighting for a 3D look.
*   **Inner Shadow**—adds a shadow inside the layer content's edges.
*   **Inner Glow**—adds a color glow that spreads inward from the edges of the layer content.
*   **Color Overlay**—applies a solid color to layer content.
*   **Gradient Overlay**—applies a linear gradient to layer content.
*   **Outer Glow**—adds a color glow that spreads outward from the edges of the layer content.
*   **Outer Shadow**—adds a shadow behind the layer content.
*   **Gaussian Blur**—blurs the layer content.

More advanced options for each layer effect are available via **Layer Effects**

![Image 5](https://images.ctfassets.net/3p2fxa94bzao/5H5oESUJMbLSy85yFmCLoV/a67d9e2c9c5e506f5040f55554ce7c1a/cog_icon_2.svg)
...
[](https://www.affinity.studio/help/panels-layer-fx-panel/#see-also:)
...
*   [Styles panel](https://www.affinity.studio/help/panels-styles-panel/)
