---
title: "Red Eye Removal Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-red-eye/
slug: tools-tools-red-eye
fetched: 2026-08-06
---

# Red Eye Removal Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-red-eye/

[Skip to main content](https://www.affinity.studio/help/tools-tools-red-eye/#_r_0_)
...
3.   Red Eye Removal Tool

# Red Eye Removal Tool

The Red Eye Removal Tool

![Image 4](https://images.ctfassets.net/3p2fxa94bzao/5J4cv7HIcSxoP3ZDPYfC1a/f2caafb202b23d86d40a9a691043e957/red_eye_removal_tool.svg)

 quickly fixes the red eye effect in your photos and preserves the detail of the eye.

[](https://www.affinity.studio/help/tools-tools-red-eye/#where-to-find-it)

### Where to find it

The Red Eye Removal Tool is not visible by default but it can be added to any Studio. See 'Customizing tools' for details.
...
[](https://www.affinity.studio/help/tools-tools-red-eye/#options)

### Options

This tool has no customizable options.

[](https://www.affinity.studio/help/tools-tools-red-eye/#shortcuts)

## Shortcuts

Desktop app

*   To select the Red Eye Removal Tool, press the **J** key. This key cycles between related tools.

[](https://www.affinity.studio/help/tools-tools-red-eye/#see-also:)
