---
title: "Provide screen recording for support - Affinity Help Center"
source: https://www.affinity.studio/help/screen-recording-for-support/
slug: screen-recording-for-support
fetched: 2026-08-06
---

# Provide screen recording for support - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/screen-recording-for-support/

[Skip to main content](https://www.affinity.studio/help/screen-recording-for-support/#_r_0_)
...
2.   Provide screen recording for support

# Provide screen recording for support

If the Affinity support team asks for a screen recording, please follow these instructions. Screen recordings are often essential for our support team to investigate your issue thoroughly.

**MacOS:**

*   See the**​​**[**How to record the screen on your Mac**](https://support.apple.com/HT208721) article

**Windows 10 & Windows 11:**

You can use XBOX Game Bar feature in Windows to record your screen:

1.   With Affinity open, press the **Windows Key** + **G** to open the Windows Game Bar. If nothing happens, make sure you have the Game Bar app installed and go to **Start**>**Settings**>**Gaming**>**Game Ba**r and make sure it’s turned **On**
2.   To start recording, press **Windows Key** +**Alt** + **R**. You will now see a small recording icon in the top right hand of your screen.
3.   Now replicate the issue you’re experiencing within Affinity.
4.   You can click the **Stop** button to stop recording, or you can press **Windows Key** + **Alt** + **R** again to also stop recording.

To access your recording, go to **This PC**>**Videos**>**Screen Recording**or browse to**C:\Users\username\Videos\Screen Recordings (default location)**

**Windows 11:**

*   See the [**Use the Snipping Tool to capture a screen recording**](https://support.microsoft.com/windows/use-snipping-tool-to-capture-screenshots-00246869-1843-655f-f220-97299b865f6b#id0edd=windows_11) article

Please attach your screen recording to your email reply to our support team or include it when submitting a new ticket through the Affinity Help Centre.
