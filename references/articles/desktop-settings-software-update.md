---
title: "Desktop settings: Software Update (Mac only) - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-software-update/
slug: desktop-settings-software-update
fetched: 2026-08-06
---

# Desktop settings: Software Update (Mac only) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-software-update/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-software-update/#_r_0_)
...
2.   Desktop settings: Software Update (Mac only)

# Desktop settings: Software Update (Mac only)

Choose an automatic software update behavior.

The following settings are available:

*   **Check for updates**—Sets how often the app will check for software updates. You can switch off update checking by selecting _Never_.

[](https://www.affinity.studio/help/desktop-settings-software-update/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-software-update/#see-also:)
...
*   [Settings: Miscellaneous](https://www.affinity.studio/help/desktop-settings-misc/)
