---
title: "Navigator panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-navigator-panel/
slug: panels-navigator-panel
fetched: 2026-08-06
---

# Navigator panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-navigator-panel/

[Skip to main content](https://www.affinity.studio/help/panels-navigator-panel/#_r_0_)
...
The Navigator panel lets you zoom into your design and pan around to view specific areas. You can also save zoom levels and positions as view points, and switch between them.

[](https://www.affinity.studio/help/panels-navigator-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **General > Navigator**

[](https://www.affinity.studio/help/panels-navigator-panel/#options)
...
*   **Zoom controls**—let you zoom in or out of your document. Use the slider or + and - buttons. The slider snaps to common zoom levels.
*   **Zoom level**—shows how much the document is magnified. To set an exact level, type a number in the box and then press the **⏎** key (Mac) / **Return** key (Windows).
*   **Current View Point**—appears when you've saved view points. Select one to return to its zoom level and position.
*   **Preview**—shows a thumbnail of the current page/spread. A rectangle denotes the area visible in the document view.
...
*   **Save Current View Point**—saves a new view point for the current zoom level and area shown in the document view.
*   **Remove Selected View Point**—deletes the view point shown on the panel.
*   **Rename View Point**—lets you name the selected view point.
...
[](https://www.affinity.studio/help/panels-navigator-panel/#see-also:)

#### SEE ALSO:

*   [Zooming](https://www.affinity.studio/help/design-aids-zoom/)
*   [Panning](https://www.affinity.studio/help/design-aids-pan/)
