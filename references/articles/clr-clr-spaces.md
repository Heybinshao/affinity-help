---
title: "Color spaces - Affinity Help Center"
source: https://www.affinity.studio/help/clr-clr-spaces/
slug: clr-clr-spaces
fetched: 2026-08-06
---

# Color spaces - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/clr-clr-spaces/

[Skip to main content](https://www.affinity.studio/help/clr-clr-spaces/#_r_0_)
...
[](https://www.affinity.studio/help/clr-clr-spaces/#about-color-space)

## About color space

Each output device, for example, your display or printer, is only capable of producing a certain range of colors. A color space is a specific implementation of the color model used to define the color gamut (i.e., the range of available color). For example, Adobe RGB, sRGB, etc, are all unique color spaces for the RGB color model. Different color spaces are also available for CMYK and LAB color models.

In order for a device to know which color space to use, it looks at the assigned color profile. You can choose your color space by assigning a [color profile](https://www.affinity.studio/help/clr-clr-profiles/) to your document.

[](https://www.affinity.studio/help/clr-clr-spaces/#which-color-models-are-supported-in-affinity-)

### Which color models are supported in Affinity?
...
Using a specific color model will let you define the color profile (and hence space) for that model.

[](https://www.affinity.studio/help/clr-clr-spaces/#which-color-space-should-i-use-)
...
If you need to use a color space that is not available in Affinity, it will have to be installed on your system. Devices can install color profiles for you. Consult your system's color management documentation for instructions.

[](https://www.affinity.studio/help/clr-clr-spaces/#see-also:)

#### SEE ALSO:

*   [About color models](https://www.affinity.studio/help/clr-clr-models/)
