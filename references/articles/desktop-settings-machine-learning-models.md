---
title: "Desktop settings: Machine Learning Models - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-machine-learning-models/
slug: desktop-settings-machine-learning-models
fetched: 2026-08-06
---

# Desktop settings: Machine Learning Models - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-machine-learning-models/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-machine-learning-models/#_r_0_)
...
2.   Desktop settings: Machine Learning Models

# Desktop settings: Machine Learning Models

Choose which Machine Learning models are installed on your device.

All models are pre-trained and because they work on device, none of your data leaves your device at any time.These models and linked functionality are only available on Apple Silicon Macs running macOS Ventura 13.0 and newer, and on Windows x64 and Arm64 hardware running Windows 10 or 11.

The following settings are available:

*   **Inference**—Choose which of your hardware components are used to perform machine learning operations. Options may vary between devices.
...
*   **Depth Estimation**—This model allows Affinity to build a depth map from any raster layer. This map is used for the Portrait Blur filter and Select Sample Depth (Pixel > Pixel Selection) feature.
*   **Colorization**—This model allows Affinity to use the Colorize filter (Pixel > Filters > Colors > Colorize).
*   **Super Resolution**—This model allows Affinity to upscale documents and placed images while maintaining quality using the Super Resolve feature (Pixel > Filters > Sharpen).

[](https://www.affinity.studio/help/desktop-settings-machine-learning-models/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-machine-learning-models/#see-also:)

#### SEE ALSO:

*   [About Settings for desktop](https://www.affinity.studio/help/workspace-settings/)
*   [Settings: Color](https://www.affinity.studio/help/desktop-settings-clr/)
