---
title: "Closing - Affinity Help Center"
source: https://www.affinity.studio/help/get-started-close/
slug: get-started-close
fetched: 2026-08-06
---

# Closing - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/get-started-close/

[Skip to main content](https://www.affinity.studio/help/get-started-close/#_r_0_)
...
When you've finished your current session or completed your design you can close your document, keeping Affinity open to work on other open documents or create new documents from scratch.

On closure, you'll be prompted to save your document if it has unsaved changes. For multiple open documents, you can save all your documents' changes in one operation or one-by-one.

[](https://www.affinity.studio/help/get-started-close/#how-to-close-a-document)
...
*   With only one document open: on the **File** menu, select **Close**.
*   With multiple documents open: with the document to be closed displayed, click **Close Document**  ![Image 4](https://images.ctfassets.net/3p2fxa94bzao/1fFUyaXVni4sbfvw4wZH1T/b22e728fcc222ad964c300b03a3151db/close_document.png)        on its document tab above your workspace.
*   Right-click the open document's tab and select **Close**.

Unmodified documents will close automatically, but you'll be prompted to save any unsaved changes.

[](https://www.affinity.studio/help/get-started-close/#how-to-close-all-documents-except-for-the-currently-opened-one)

### How to close all documents except for the currently opened one

Desktop app

1.   With more than one document open, right-click the active document's tab and select **Close Others.**

[](https://www.affinity.studio/help/get-started-close/#how-to-close-all-documents)

### How to close all documents

Desktop app

1.   Do one of the following:

*   On the **File** menu, select **Close All**.
*   Right-click the open document's tab and select **Close All**.

2. (Optional) On the dialog, when **Apply To All** is unchecked, you'll be prompted to save or not save _each_ modified document one-by-one as they close. When checked, all documents will automatically close, saving or not saving for _all_ modified documents if needed.

Close All will attempt to close all open documents across all Studios.

[](https://www.affinity.studio/help/get-started-close/#see-also:)

#### SEE ALSO:

*   [Opening and importing](https://www.affinity.studio/help/get-started-open-document/)
*   [Saving](https://www.affinity.studio/help/get-started-save/)
