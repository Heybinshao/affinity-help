---
title: "Force Pixel Alignment - Affinity Help Center"
source: https://www.affinity.studio/help/design-aids-pixel-align/
slug: design-aids-pixel-align
fetched: 2026-08-06
---

# Force Pixel Alignment - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/design-aids-pixel-align/
...
[Skip to main content](https://www.affinity.studio/help/design-aids-pixel-align/#_r_0_)
...
3.   Force Pixel Alignment

# Force Pixel Alignment

Force Pixel Alignment will snap vector objects, nodes and handles, and pixel selection areas to whole pixels when created, moved or modified. If this option is switched off, objects and selections can occupy partial pixels.

This snapping method, particularly useful for web graphic development, works together with other forms of snapping. If you snap to an object that is not aligned to a pixel, then the resulting snap will not be pixel aligned. To snap only to pixels, be sure to switch off other modes of non-pixel snapping, such as grids and guides if they are not on-pixel.

[](https://www.affinity.studio/help/design-aids-pixel-align/#move-by-whole-pixels)

## Move By Whole Pixels

In addition to Force Pixel Alignment, the Move By Whole Pixels option allows you to constrain the movement of vector objects, nodes and handles to whole pixels.
...
[](https://www.affinity.studio/help/design-aids-pixel-align/#how-to-activate-deactivate-force-pixel-alignment)

### How to activate/deactivate Force Pixel Alignment

Desktop app

1.   On the **View** menu, select **Snapping**.
2.   On the **Snapping** dialog, check **Force Pixel Alignment**.

[](https://www.affinity.studio/help/design-aids-pixel-align/#how-to-activate-deactivate-move-by-whole-pixels)

### How to activate/deactivate Move By Whole Pixels

Desktop app

*   On the **View** menu, select **Snapping**.
*   On the **Snapping** dialog, check **Move By Whole Pixels**.

[](https://www.affinity.studio/help/design-aids-pixel-align/#see-also:)
