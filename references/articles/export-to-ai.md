---
title: "Is it possible to export to .AI (Adobe Illustrator) file format? - Affinity Help Center"
source: https://www.affinity.studio/help/export-to-ai/
slug: export-to-ai
fetched: 2026-08-06
---

# Is it possible to export to .AI (Adobe Illustrator) file format? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/export-to-ai/

[Skip to main content](https://www.affinity.studio/help/export-to-ai/#_r_0_)
...
3.   Is it possible to export to .AI (Adobe Illustrator) file format?

# Is it possible to export to .AI (Adobe Illustrator) file format?

The .ai (Adobe Illustrator) file format is a proprietary Adobe format and is closed to other applications. Therefore, it is not possible to export this file type from Affinity.
