---
title: "How do I update Affinity? - Affinity Help Center"
source: https://www.affinity.studio/help/update-affinity/
slug: update-affinity
fetched: 2026-08-06
---

# How do I update Affinity? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/update-affinity/

[Skip to main content](https://www.affinity.studio/help/update-affinity/#_r_0_)
...
3.   How do I update Affinity?

# How do I update Affinity?

[](https://www.affinity.studio/help/update-affinity/#for-macos-users:)

## **For macOS Users:**

Each time you start Affinity, it will check for updates and offer any available update, or in the application’s **Affinity Menu,**there is an option **Check for Updates**.

[](https://www.affinity.studio/help/update-affinity/#for-windows-users:)

## **For Windows Users:**

Each time you start Affinity, it will check for updates and offer any available update, or in the application’s **Help menu,** there is an option **Check for Updates**.

The app must be opened to check for updates and then perform the update. You can check which is the latest released version in the [release notes](https://www.affinity.studio/help/release-notes/).
