---
title: "Document statistics - Affinity Help Center"
source: https://www.affinity.studio/help/text-document-stats/
slug: text-document-stats
fetched: 2026-08-06
---

# Document statistics - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/text-document-stats/

[Skip to main content](https://www.affinity.studio/help/text-document-stats/#_r_0_)
...
Affinity can optionally display a count of the number of words, characters, paragraphs or lines in the current document or selection.

[](https://www.affinity.studio/help/text-document-stats/#about-statistics)

## About statistics

Document statistics can be helpful when commissioning writers to ensure they provide a suitable amount of text, e.g. for magazine and newspaper articles.

Affinity can display one of several statistics in the status bar, between the preflight status indicator and the hintline. You can choose whether it shows a count of **words**, **characters**, **characters including spaces**, **lines** or **paragraphs**.

The count's value changes according to your current selection:

*   When no text objects are selected, the count is for all text objects in the current document.
*   When one or more text objects are selected, the count is for text in all of them.
*   When a linked text frame is selected, the count includes text in all frames linked to it.
*   When an insertion point exists within text, all text in the text object is counted.
*   When a range of text is selected, only that range is counted.

The count updates soon after you stop typing.

[](https://www.affinity.studio/help/text-document-stats/#overset-text)

### Overset text

The count may display a second value in brackets. This value is the amount of overset text in the selection (including unselected frames linked to it), or in the whole document (if nothing is selected).

[](https://www.affinity.studio/help/text-document-stats/#how-to-show-hide-document-statistics)

### How to show/hide document statistics

Desktop app

1.   On the **View** menu, select **Show > Word Count**.
2.   (Optional) Click the count to show a pop-up menu of counts in various units: words, characters (including or excluding spaces), lines, and paragraphs.
3.   (Optional) Select a statistic from the menu to see that one on the status bar.

[](https://www.affinity.studio/help/text-document-stats/#see-also:)
