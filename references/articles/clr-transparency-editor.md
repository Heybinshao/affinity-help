---
title: "Transparency editing - Affinity Help Center"
source: https://www.affinity.studio/help/clr-transparency-editor/
slug: clr-transparency-editor
fetched: 2026-08-06
---

# Transparency editing - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/clr-transparency-editor/

[Skip to main content](https://www.affinity.studio/help/clr-transparency-editor/#_r_0_)
...
3.   Transparency editing

# Transparency editing

Using the same principles as gradient editing, transparency editing lets you customize a gradient but just on the alpha channel in your design. This allows for more complex transparency gradients to be made, and then applied to object fills and strokes.

[](https://www.affinity.studio/help/clr-transparency-editor/#settings)

### Settings

The following settings can be adjusted in the Transparency editor dialog accessed from the Transparency Tool's context toolbar. It's also possible to adjust most of these settings directly on the gradient path.
...
See the [Gradient, bitmap and hatch fills](https://www.affinity.studio/help/clr-gradient-editor/) topic for the procedure but use the Transparency Tool instead of the Fill Tool.

[](https://www.affinity.studio/help/clr-transparency-editor/#see-also:)
