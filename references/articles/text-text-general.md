---
title: "Working with text - Affinity Help Center"
source: https://www.affinity.studio/help/text-text-general/
slug: text-text-general
fetched: 2026-08-06
---

# Working with text - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/text-text-general/

[Skip to main content](https://www.affinity.studio/help/text-text-general/#_r_0_)
...
There are several varieties of text—artistic, frame, path, and shape—to give you flexibility when working with typography.

![Image 4: Text types](https://images.ctfassets.net/3p2fxa94bzao/5Q6r3YSYOTB8isq1S1ghDW/d396913693ed19c213367fdcca201fed/text_types.jpg)

All text types can be formatted quickly using settings on the context toolbar, such as font family, size, format, and alignment. Advanced options are available on the **Character** and **Paragraph** panels.

When editing text, Affinity supports standard text selection and formatting techniques and shortcuts—see [Editing text](https://www.affinity.studio/help/text-text-editing/).

The unique features of each type of text are discussed in the [Artistic text](https://www.affinity.studio/help/text-art-text/), [Frame text](https://www.affinity.studio/help/text-frame-text/), [Text on a path](https://www.affinity.studio/help/text-path-text/), and [Shape text](https://www.affinity.studio/help/text-shape-text/) topics.

[](https://www.affinity.studio/help/text-text-general/#settings)

## Settings

Desktop app

Related behaviors can be adjusted in the app's [Settings](https://www.affinity.studio/help/workspace-settings/):

*   **User Interface > Show Text in points**
*   **User Interface > Always use white background for font dropdown**
*   **Tools > Create Text with Blend Gamma**

[](https://www.affinity.studio/help/text-text-general/#see-also:)

#### SEE ALSO:

*   [Artistic text](https://www.affinity.studio/help/text-art-text/)
*   [Frame text](https://www.affinity.studio/help/text-frame-text/)
*   [Path text](https://www.affinity.studio/help/text-path-text/)
