---
title: "Delete account - Affinity Help Center"
source: https://www.affinity.studio/help/delete-account/
slug: delete-account
fetched: 2026-08-06
---

# Delete account - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/delete-account/

Once deleted, your account can’t be recovered. If you’re on Canva Pro, Canva Teams, or Canva Business, cancel your plan first to avoid continuous charges.All your designs, folders, templates, uploads, as well as teams and apps that you created will be permanently deleted as well.

[Skip to main content](https://www.affinity.studio/help/delete-account/#_r_0_)
...
You can delete your Canva account from the Settings page.

*   Once deleted, your account **can’t be recovered**.
*    If you’re on Canva Pro, Canva Teams, or Canva Business, [cancel your plan](https://www.affinity.studio/help/cancel-canva-plan/) first to avoid continuous charges.
*   All your designs, folders, templates, uploads, as well as teams and apps that you created will be **permanently deleted** as well.

Quick tip

Delete your account now.

[Open Settings](https://www.canva.com/settings/login-and-security)

[](https://www.affinity.studio/help/delete-account/#how-to-delete-your-account)
...
1.   On the homepage, select your profile icon. 
2.   Select **Settings**.
3.   Go to **Login**, then select **Delete Account.**
4.   **[With password]** Enter your password to confirm. **[Without password]** This will prompt you to enter a code sent to your registered email address. Check your inbox and enter the code into the pop-up window.
5.   Select **Delete Account**to finalize the process.

After submitting your request, your account will be deleted in **14 days**. You can cancel your request by simply logging in to your account.

If you delete your Canva account, you can keep using Affinity offline for 14 days. After that, you’ll need a Canva account to access Affinity.

[](https://www.affinity.studio/help/delete-account/#error-when-trying-to-delete-account)

## Error when trying to delete account

This likely means that you own a Creator or a Contributor team. These teams _can only be deactivated on our end_ to prevent Canva designs using your library content from breaking, and to allow us to continue paying you royalties.

To request deletion of your public details and for the deactivation of your library content so it’s not available for new designs, [contact us here](https://www.canva.com/help/creators-support-form).

[](https://www.affinity.studio/help/delete-account/#need-access-to-your-designs-later-)

## Need access to your designs later?

Download the designs that you want to keep before deleting your account. Learn how to [download your designs.](https://www.canva.com/help/bulk-download-data-uploads-designs)

If you still have questions or problems about deleting your account, [contact our Support Team](https://www.canva.com/help/get-in-touch/contact-support?issue_category=account-billing&issue=delete-account).
