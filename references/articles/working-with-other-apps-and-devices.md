---
title: "Working with other apps and devices - Affinity Help Center"
source: https://www.affinity.studio/help/working-with-other-apps-and-devices/
slug: working-with-other-apps-and-devices
fetched: 2026-08-06
---

# Working with other apps and devices - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/working-with-other-apps-and-devices/

[Skip to main content](https://www.affinity.studio/help/working-with-other-apps-and-devices/#_r_0_)
...
2.   Working with other apps and devices

# Working with other apps and devices

Use Affinity in specialist workflows and with pen tablets and other accessories

* * *

### Apps

*   [Editing Capture One content in Affinity](https://www.affinity.studio/help/addons-capture-one/)
*   [Importing Affinity content into DaVinci Resolve](https://www.affinity.studio/help/extras-davinci-affinity/)
...
*   [Using Surface Pen (Windows)](https://www.affinity.studio/help/extras-surface-pen/)
*   [Using Surface Dial (Windows)](https://www.affinity.studio/help/extras-surface-dial/)
*   [Using a trackpad (Mac)](https://www.affinity.studio/help/extras-trackpads/)
*   [Using Sidecar (Mac)](https://www.affinity.studio/help/extras-sidecar/)
...
Displaying 2 of 2 links. Use the See All button at the end of the list to show all topics.Displaying 5 of 5 links. Use the See All button at the end of the list to show all topics.
