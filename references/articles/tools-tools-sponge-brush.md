---
title: "Sponge Brush Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-sponge-brush/
slug: tools-tools-sponge-brush
fetched: 2026-08-06
---

# Sponge Brush Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-sponge-brush/

1.   [Help Center](https://www.affinity.studio/help/)
2.   [Photo editing](https://www.affinity.studio/help/photo-editing/)
3.   Sponge Brush Tool

The Sponge Brush Tool

![Image 1](https://images.ctfassets.net/3p2fxa94bzao/2qPnMRlMX17p2PqCNazjlj/2ac51756cf74aaed4d65a011dba19a06/sponge_brush_tool.svg)

 can be used to selectively saturate or desaturate areas within an image.

The Sponge Brush Tool is available by default in Pixel Studio, on the Adjustment Brush Tool's flyout.
...
*   **Stabilizer**—enables stroke stabilization using either a **Rope mode** or **Window mode**; the former drags the stroke end by a 'rope' to smooth the stroke but lets you introduce sharp corners at increasing rope **Length** (radius) values by redirecting the slackened rope; the latter will smooth the stroke by averaging sampled input positions within a **Window** whose size is configurable.
...
*   **Vibrance**—when selected, brush strokes adjust the intensity of subtle colored pixels, while minimizing clipping of highly saturated colored pixels.
*   **HSL Saturation**—when selected, adjusts the color intensity of all pixels.
*   ![Image 8](https://images.ctfassets.net/3p2fxa94bzao/2Jk9PNrTpGzTAFr2oVmFcS/b539869ec6cc10a4455b3728c9837382/wetedges.svg) **Wet Edges**—builds paint up along the edges of your pixel brush stroke, producing a watercolor effect. Check **Custom** and either apply a preset **Standard profile** or draw a custom profile using the chart; both subtly changes how watery the stroke appears.
*   ![Image 9](https://images.ctfassets.net/3p2fxa94bzao/48gU5vr3XwFWtBjwhAJWTo/28e1a43a4063087555940fbc383932d4/reset-global.svg) **Reset**—resets brush settings to their defaults.
*   ![Image 10](https://images.ctfassets.net/3p2fxa94bzao/7eblP76vdFdrp2uaZ3g2uC/4609ca56c51ddfe4b1aeb480e5ac5d9e/view.svg) **Symmetry settings**—offers various symmetry line control options.
...
*   To select the Sponge Brush Tool, press the **O** key. This key cycles between related tools.
