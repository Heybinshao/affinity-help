---
title: "Why does Affinity crash on Windows when opening, importing, or creating new documents? - Affinity Help Center"
source: https://www.affinity.studio/help/affinity-crash-on-windows/
slug: affinity-crash-on-windows
fetched: 2026-08-06
---

# Why does Affinity crash on Windows when opening, importing, or creating new documents? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/affinity-crash-on-windows/

[Skip to main content](https://www.affinity.studio/help/affinity-crash-on-windows/#_r_0_)
...
2.   ... 
3.   Why does Affinity crash on Windows when opening, importing, or creating new documents? 

# Why does Affinity crash on Windows when opening, importing, or creating new documents?

If your Affinity app crashes on Windows when opening, importing, or creating a new document, it's likely to be due to outdated GPU drivers.To download the latest driver, please visit the manufacturer's links provided below:
...
If you encounter an 'OEM drivers' warning when attempting to install a driver from the above sites, you may need to obtain the driver directly from your PC manufacturer's website.If your device has multiple GPUs (e.g., integrated Intel graphics and a dedicated external GPU card), make sure the drivers for both are completely up to date.After downloading and installing the latest GPU drivers, please restart your computer. Then, relaunch the Affinity app.If the app continues to crash, try disabling Hardware Acceleration. Launch the app while holding down the **CTRL** key. In the **Clear User Data**window, select only **Disable Hardware Acceleration**, then click**Clear**. The app will then launch with hardware acceleration disabled.
