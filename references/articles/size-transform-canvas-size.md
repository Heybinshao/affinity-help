---
title: "Changing canvas size - Affinity Help Center"
source: https://www.affinity.studio/help/size-transform-canvas-size/
slug: size-transform-canvas-size
fetched: 2026-08-06
---

# Changing canvas size - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/size-transform-canvas-size/

[Skip to main content](https://www.affinity.studio/help/size-transform-canvas-size/#_r_0_)
...
In Affinity there are options to resize the canvas of opened images and newly created documents.
...
![Image 3: After](https://images.ctfassets.net/3p2fxa94bzao/6UMgj0ozVXtIxlod7JOk6W/596a1d1ac9b0ea7f369d405ebc73747e/canvas_after.jpg)

After resizing the image canvas

![Image 4: Before](https://images.ctfassets.net/3p2fxa94bzao/5TG3BpELUvtVHDfJFs3MEv/58030663b43e9ff52412a9ad819656c2/canvas_before.jpg)

Before resizing the image canvas
...
[](https://www.affinity.studio/help/size-transform-canvas-size/#how-to-change-canvas-size)

### How to change canvas size

Desktop app

1.   On the **Document** menu, select **Setup > Resize > Canvas**.
...
[](https://www.affinity.studio/help/size-transform-canvas-size/#how-to-remove-unwanted-canvas-areas)

### How to remove unwanted canvas areas

Desktop app

*   On the **Document** menu, select **Clip Canvas**.

[](https://www.affinity.studio/help/size-transform-canvas-size/#how-to-expand-the-canvas-to-fit-layer-content)

### How to expand the canvas to fit layer content

Desktop app

*   On the **Document** menu, select **Unclip Canvas**.

The **Crop Tool** can also be used to resize the canvas: either cropping into an image or expanding the crop boundary outside the image will resize the canvas when the crop is applied.

[](https://www.affinity.studio/help/size-transform-canvas-size/#see-also:)
