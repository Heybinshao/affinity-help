---
title: "Renaming layers - Affinity Help Center"
source: https://www.affinity.studio/help/layers-rename-layers/
slug: layers-rename-layers
fetched: 2026-08-06
---

# Renaming layers - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/layers-rename-layers/

[Skip to main content](https://www.affinity.studio/help/layers-rename-layers/#_r_0_)
...
Renaming lets you more easily identify specific items in your Layers panel.

[](https://www.affinity.studio/help/layers-rename-layers/#how-to-rename-a-layer)
...
*   Double-click the layer's label and type a new name.
*   On the **Layer** menu, select **Rename**.

If you use distinctive memorable names you can easily distinguish them from default layer names such as _Curve_, _Layer 1_, _Rectangle_, etc.

[](https://www.affinity.studio/help/layers-rename-layers/#shortcuts)

## Shortcuts

Desktop app

*   For easier sequential renaming, the **⇥** key (Mac) / **Tab** key (Windows) will take you to the layer lower down the stack, whereas the **⇧****⇥** keys (Mac) / **Shift**+**Tab** keys (Windows) switches to the layer higher up.

[](https://www.affinity.studio/help/layers-rename-layers/#settings)
...
*   **User Interface > Ask for name when creating Layers and Groups**. You'll be prompted to name them upon creation.

[](https://www.affinity.studio/help/layers-rename-layers/#see-also:)
