---
title: "Using Single Sign-On (SSO) in Affinity - Affinity Help Center"
source: https://www.affinity.studio/help/sso-in-affinity/
slug: sso-in-affinity
fetched: 2026-08-06
---

# Using Single Sign-On (SSO) in Affinity - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/sso-in-affinity/

[Skip to main content](https://www.affinity.studio/help/sso-in-affinity/#_r_0_)
...
3.   Using Single Sign-On (SSO) in Affinity

# Using Single Sign-On (SSO) in Affinity

For teams using Canva Enterprise or Canva Education, Affinity can be accessed via Single Sign-On (SSO) if SSO has been enabled for Canva.

[](https://www.affinity.studio/help/sso-in-affinity/#how-to-log-into-affinity-with-sso)

### How to log into Affinity with SSO

Desktop app

1.   Launch Affinity.
2.   Click **Log in or sign up** on the splash screen.
3.   A browser window will open and you will be taken to [Canva.com](http://canva.com/) to login.
4.   Enter your work email address linked to your Canva Enterprise or Education account.
5.   If SSO is set up, you’ll be redirected to your organization’s login page.
6.   Enter your SSO credentials and follow the prompts to finish logging in.

For further details regarding Canva and Single Sign-On (SSO), please refer to the help articles provided below:

*   [Log in using Single Sign-On (SSO)](https://www.canva.com/help/log-in-sso/)
*   [Setting up Single Sign-On (SSO) for Enterprise](https://www.canva.com/help/set-up-sso/)
*   [Setting up Single Sign-On (SSO) for Education](https://www.canva.com/help/set-up-sso-edu/)

If you have any questions or concerns about your Canva account and Single Sign-On (SSO), please contact the [Canva Support team](https://www.canva.com/help/log-in-sso/?query=SSO).
