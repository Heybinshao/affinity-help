---
title: "Desktop settings: Miscellaneous - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-misc/
slug: desktop-settings-misc
fetched: 2026-08-06
---

# Desktop settings: Miscellaneous - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-misc/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-misc/#_r_0_)
...
2.   Desktop settings: Miscellaneous

# Desktop settings: Miscellaneous

Reset selected resources and user defaults to their original factory settings to resolve issues or return the app to a clean state.
...
*   **Reset Text Styles**
*   **Reset User Defaults**
*   **Reset Fonts**—(Mac only) updates the font cache to the current state of the system (from memory).

[](https://www.affinity.studio/help/desktop-settings-misc/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-misc/#see-also:)
