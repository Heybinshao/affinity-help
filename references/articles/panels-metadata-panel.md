---
title: "Metadata panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-metadata-panel/
slug: panels-metadata-panel
fetched: 2026-08-06
---

# Metadata panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-metadata-panel/

[Skip to main content](https://www.affinity.studio/help/panels-metadata-panel/#_r_0_)
...
[](https://www.affinity.studio/help/panels-metadata-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **Pixel > Metadata**

[](https://www.affinity.studio/help/panels-metadata-panel/#about-metadata)

## About metadata

[](https://www.affinity.studio/help/panels-metadata-panel/#options)
...
*   **Metadata entries**—depending on the metadata type selected, field values allow you to enter information, as needed. Select metadata type from the drop-down list.
...
*   **Import from XMP**—loads metadata (such as keywords, ratings, or edits) from an external XMP sidecar file into your image.
*   **Export to XMP**—saves your image metadata (such as keywords, ratings, or edits) into a separate XMP sidecar file for use in other applications.
*   **Strip GPS Location**—removes GPS coordinates from your image metadata to protect location privacy.
*   **Strip All EXIF**—removes all Exif metadata (such as camera settings, date, location, and device information) from your image to enhance privacy and reduce file size.
...
[](https://www.affinity.studio/help/panels-metadata-panel/#see-also:)
