---
title: "Linear Fit filter - Affinity Help Center"
source: https://www.affinity.studio/help/filters-filter-linear-fit/
slug: filters-filter-linear-fit
fetched: 2026-08-06
---

# Linear Fit filter - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/filters-filter-linear-fit/

[Skip to main content](https://www.affinity.studio/help/filters-filter-linear-fit/#_r_0_)
...
The Linear Fit filter balances the brightness data to fix color cast in stacked monochromatic astrophotography imagery.

After

Before

![Image 3: After](https://images.ctfassets.net/3p2fxa94bzao/Q4ntCC4Tn8gWOmZ5CqAze/0023085296586a7f04d342e56b6011da/filter_linearFit_after.jpg)

This feature is only available in Affinity for desktop.

[](https://www.affinity.studio/help/filters-filter-linear-fit/#about-the-linear-fit-filter)

## About the Linear Fit filter

This filter can be found on the **Pixel > Filters > Astrophotography** menu.

Stacking and blending monochromatic astro images may often result in one of the following:

*   uneven color cast
*   varied tones data

Applying the **Linear Fit** filter helps to even out these differences and ensures a better starting point to further tone stretching and color rework. For best results, it is recommended that the image layers are color-mapped first and blended together using the Add blend mode.

The filter has no customizable settings.

[](https://www.affinity.studio/help/filters-filter-linear-fit/#see-also:)
