---
title: "Arrange pages - Affinity Help Center"
source: https://www.affinity.studio/help/pages-arrange-pages/
slug: pages-arrange-pages
fetched: 2026-08-06
---

# Arrange pages - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/pages-arrange-pages/

[Skip to main content](https://www.affinity.studio/help/pages-arrange-pages/#_r_0_)
...
You can move a document's publication pages on the Pages panel.

Use drag and drop to move pages when the new location is near the current one.

To move pages further, you can choose a destination on a dialog.

[](https://www.affinity.studio/help/pages-arrange-pages/#arranging-pages-using-drag-and-drop)

## Arranging pages using drag and drop

When you drag page thumbnails:

*   A blue line shows where the pages will go when dropped.
*   The cursor indicates whether dropping will start a new spread or extend an existing one.
*   Where pages can go depends on whether **Reflow Pages** (on the Pages panel's preferences menu) is enabled or disabled.

When Reflow Pages is enabled, pages reflow from whichever comes first—either the first page in the selection or the drop location—through to the end of your document.

When Reflow Pages is disabled, pages will not automatically reflow. This can create “ghost pages”.

[](https://www.affinity.studio/help/pages-arrange-pages/#how-to-move-pages--using-drag-and-drop-)

### How to move pages (using drag and drop)
...
2.   Hover where you want to move the pages and drop when the cursor shows the required action will happen.

Be careful when moving master pages. If you drop one master onto another, the first is applied to the second.

[](https://www.affinity.studio/help/pages-arrange-pages/#how-to-move-publication-pages--via-dialog-)

### How to move publication pages (via dialog)

Desktop app

1.   On the **Pages** panel: 
    1.   Select one or more publication pages 1.
    2.   **^(ctrl)**-click (Mac) / **right**-click (Windows) one of the selected pages and select **Move/Copy Pages**. 

2.   On the dialog that appears: 
    1.   Specify the **Page** number, and whether to position the pages **Before** or **After** it.
    2.   Select **Move**.
    3.   Select **OK**.

1 Alternatively, specify the pages later, by typing their numbers on the dialog.

[](https://www.affinity.studio/help/pages-arrange-pages/#see-also:)

#### SEE ALSO:

*   [Add and remove pages](https://www.affinity.studio/help/pages-add-delete-pages/)
*   [Copy and duplicate pages](https://www.affinity.studio/help/pages-copy-duplicate-pages/)
...
*   [About ghost pages](https://www.affinity.studio/help/pages-ghost-pages/)
*   [Keyboard shortcuts for the Layout Studio](https://www.affinity.studio/help/workspace-shortcuts-layout-studio/)
