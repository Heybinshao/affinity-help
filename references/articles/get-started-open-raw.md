---
title: "Opening a RAW image - Affinity Help Center"
source: https://www.affinity.studio/help/get-started-open-raw/
slug: get-started-open-raw
fetched: 2026-08-06
---

# Opening a RAW image - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/get-started-open-raw/

[Skip to main content](https://www.affinity.studio/help/get-started-open-raw/#_r_0_)
...
3.   Opening a RAW image

# Opening a RAW image

You can open RAW images from your digital camera directly into the Develop Studio. In doing so, you'll be able to process the unprocessed image, deciding for yourself how your image is to be developed.

Processing RAW images is carried out exclusively within the Develop Studio. Once you commit to how you want to your image to be developed, the image can then be worked on in other Studios.

For a comprehensive up-to-date list of RAW file support, please see the following links:

*   [Affinity RAW](https://www.affinity.studio/help/supported-raw-files/) (Mac & Windows)
*   [Apple Core Image RAW](https://affin.co/rawapple) (Mac only)

[](https://www.affinity.studio/help/get-started-open-raw/#how-to-open-a-raw-image)
...
2.   Select the RAW file you want and click **Open**.

The RAW image is loaded into the Develop Studio for processing.

[](https://www.affinity.studio/help/get-started-open-raw/#how-to-open-a-recently-used-raw-image)

### How to open a recently used RAW image

Desktop app

*   On the **File** menu, click **Open Recent**, then select a RAW file from the submenu.

[](https://www.affinity.studio/help/get-started-open-raw/#how-to-open-a-raw-image-by-drag-and-drop)

### How to open a RAW image by drag and drop
...
*   For Windows: Open File Explorer and drag the file to any menu or toolbar (not your page or pasteboard).

[](https://www.affinity.studio/help/get-started-open-raw/#see-also:)
