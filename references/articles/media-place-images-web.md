---
title: "Placing images from the Web - Affinity Help Center"
source: https://www.affinity.studio/help/media-place-images-web/
slug: media-place-images-web
fetched: 2026-08-06
---

# Placing images from the Web - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/media-place-images-web/

Sometimes, placing an image as a remote resource may not work due to issues beyond Affinity's control. In that case, try embedding it instead.

[Skip to main content](https://www.affinity.studio/help/media-place-images-web/#_r_0_)
...
3.   Placing images from the Web

# Placing images from the Web

Raster images can be placed by dragging and dropping them from a web browser.

They can be placed as an embedded resource or a remote resource.

[](https://www.affinity.studio/help/media-place-images-web/#about-remote-resources)

## About remote resources

This feature is only available in Affinity for desktop.

Placing an image as a remote resource records its address (URL) in your document. Affinity checks for changes and either updates the resource automatically or alerts you, based on the auto-update behavior setting in its General settings.

You can embed remote resources at any time—e.g. before printing or archiving your document. The document keeps the resource's address, so you can make it remote again later.

Sometimes, placing an image as a remote resource may not work due to issues beyond Affinity's control. In that case, try embedding it instead.

[](https://www.affinity.studio/help/media-place-images-web/#about-embedded-resources)

### About embedded resources

If you place an image from the Web as an embedded resource, its source address is not recorded. If the image in your document needs to be updated, you must repeat the steps to place the latest version from the Web.

[](https://www.affinity.studio/help/media-place-images-web/#how-to-place-an-image-from-a-web-page)

### How to place an image from a web page

Desktop app

1.   Drag the image from your web browser.
2.   Do one of the following: 
    *   To make the image an embedded resource, drop it onto your document in Affinity.
    *   To make the image a remote resource, hold the **⌃(ctrl)** key (Mac) / **Ctrl** key (Windows) and drop the image onto your document in Affinity. 

[](https://www.affinity.studio/help/media-place-images-web/#see-also:)

#### SEE ALSO:

*   [Placing content](https://www.affinity.studio/help/media-place-images/)
*   [Autoflowing images and documents](https://www.affinity.studio/help/media-place-images-autoflow/)
