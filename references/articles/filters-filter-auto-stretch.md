---
title: "Auto Stretch filter (Astrophotography) - Affinity Help Center"
source: https://www.affinity.studio/help/filters-filter-auto-stretch/
slug: filters-filter-auto-stretch
fetched: 2026-08-06
---

# Auto Stretch filter (Astrophotography) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/filters-filter-auto-stretch/

[Skip to main content](https://www.affinity.studio/help/filters-filter-auto-stretch/#_r_0_)
...
2.   Auto Stretch filter (Astrophotography)

# Auto Stretch filter (Astrophotography)

The Auto Stretch filter automatically stretches stacked astrophotography images to reveal faint detail while preserving important highlights. It provides a quick starting point for bringing out structure in deep-sky images without manually building a stretch from scratch.

This feature is only available in Affinity for desktop.

[](https://www.affinity.studio/help/filters-filter-auto-stretch/#about-the-auto-stretch-filter)

## About the Auto Stretch filter

Auto Stretch is designed for post-processing stacked astrophotography images. It expands faint signal aggressively enough to reveal dim structures while protecting brighter regions such as stars and nebula cores from overexposure.

The filter offers two stretch styles: **Neutral** and **Balanced**. In general, Neutral produces less color in brighter detail, while Balanced tends to preserve more color. Results may vary depending on the image data.

The **HDR** variants stretch detail further into high dynamic range values. This can produce more vibrant results for HDR workflows and provides greater flexibility if you intend to apply your own tone mapping afterwards.

[](https://www.affinity.studio/help/filters-filter-auto-stretch/#where-to-find-it)

### Where to find it

This filter can be found on the **Pixel > Filters > Astrophotography** menu.

Use **Auto Stretch** as an initial enhancement step when your stacked image appears very dark or flat and you want to reveal faint astronomical detail quickly.

[](https://www.affinity.studio/help/filters-filter-auto-stretch/#settings)
...
*   **Neutral**—applies an automatic stretch that prioritises tonal expansion while generally producing less color in brighter detail.
*   **Balanced**—applies an automatic stretch that maintains more color in brighter regions while still revealing faint detail.
*   **HDR Neutral**—applies the Neutral stretch further into high dynamic range values for HDR-oriented workflows.
*   **HDR Balanced**—applies the Balanced stretch further into high dynamic range values, producing a more vibrant HDR result while preserving more color in brighter detail.

The HDR options are useful when you want to apply your own tone mapping method after stretching.

[](https://www.affinity.studio/help/filters-filter-auto-stretch/#see-also:)
