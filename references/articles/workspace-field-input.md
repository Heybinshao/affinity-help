---
title: "Field input - Affinity Help Center"
source: https://www.affinity.studio/help/workspace-field-input/
slug: workspace-field-input
fetched: 2026-08-06
---

# Field input - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/workspace-field-input/

[Skip to main content](https://www.affinity.studio/help/workspace-field-input/#_r_0_)
...
There are several ways to enter, adjust and convert field values.

[](https://www.affinity.studio/help/workspace-field-input/#setting-field-values)

## Setting field values

Field values can be set using any of the following methods:

Desktop app

*   Input the value directly into the field.
*   Drag slider handles to increase or decrease the field value.
*   Drag left or right across input boxes (only available for certain settings such as Opacity and Transform X, Y, W, H).

[](https://www.affinity.studio/help/workspace-field-input/#converting-field-input)

## Converting field input

When you enter a value in a different unit of measurement, it is automatically converted to the unit type used in the field.

For example, entering a value of 9 cm to a field that uses mm will result in a value of 90 mm.

[](https://www.affinity.studio/help/workspace-field-input/#fine-adjustment-of-input-values--mouse-wheel-)

## Fine adjustment of input values (Mouse wheel)

This feature is only available in Affinity for desktop.

You can use the mouse wheel to change a field's input value.

*   Use the mouse wheel only for a single unit increment/decrement.
*    Hold **⇧** (Mac) / **Shift** (Windows) while using the mouse wheel for a 10-unit increment/decrement. 
*    For Mac: Hold **⌥** while using the mouse wheel for a 1/10-unit increment/decrement. 
*    For Windows: Hold **Ctrl** while using the mouse wheel for a 1/10-unit increment/decrement. 

[](https://www.affinity.studio/help/workspace-field-input/#see-also:)
