---
title: "Language settings - Affinity Help Center"
source: https://www.affinity.studio/help/language-settings/
slug: language-settings
fetched: 2026-08-06
---

# Language settings - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/language-settings/

[Skip to main content](https://www.affinity.studio/help/language-settings/#_r_0_)
...
You can change the language of the Affinity user interface independently of your operating system at any time.

[](https://www.affinity.studio/help/language-settings/#how-to-change-language-settings)
...
3.   Under **Language**, select your preferred language from the pop-up menu. If needed, scroll down to reveal this option.
4.   Close the dialog.
5.   Restart the app, as prompted, for the change to take effect.

Affinity's available languages are independent of Canva. If you're looking to change the language on Canva, refer to the [Canva language settings](https://www.canva.com/help/language-settings/).

[](https://www.affinity.studio/help/language-settings/#see-also:)

#### SEE ALSO:

*   [Desktop settings (General)](https://www.affinity.studio/help/desktop-settings-general/)
*   [Language settings (Canva)](https://www.canva.com/help/language-settings/)
