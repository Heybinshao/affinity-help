---
title: "Color Picker Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-clrpicker/
slug: tools-tools-clrpicker
fetched: 2026-08-06
---

# Color Picker Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-clrpicker/

[Skip to main content](https://www.affinity.studio/help/tools-tools-clrpicker/#_r_0_)
...
3.   [Graphic design](https://www.affinity.studio/help/graphic-design/)
4.   [Page layout](https://www.affinity.studio/help/page-layout/)
5.   Color Picker Tool
...
![Image 4](https://images.ctfassets.net/3p2fxa94bzao/2lcYpUSuuMpRjhKGSFgJwC/ecc58c08ce83957c9dcd488a4d51fd8f/Colour_picker_tool.svg)

 allows you to sample colors from anywhere on your document or screen.

[](https://www.affinity.studio/help/tools-tools-clrpicker/#where-to-find-it)

### Where to find it

The Color Picker Tool is available by default in Vector, Pixel and Layout Studios.

It can be added to other Studios. See 'Customizing tools' for details.

Sampled (or picked) colors from the Color Picker Tool are stored in the swatch next to the tool's icon on the **Color** or **Swatches** panel.

Tool shortcut key: **I**

[](https://www.affinity.studio/help/tools-tools-clrpicker/#settings)
...
*   **Apply to Selection**—when selected (default), the picked color will automatically apply to the selected object's Fill or Stroke, depending on which color selector is active on the Color or Swatches panel. With image layers, the selected color is applied onto the image as a tint. When this option is off, the picked color is not automatically applied.
*   **Magnification**—when enabled, a magnification loupe is used to help sample color accurately. When disabled, a crosshair cursor is used instead.
*   **Source**—determines from where the tool can pick colors—**Current Layer** restricts picking to the currently selected layer or object; **Global** picks from all layers.
*   **Radius**—choose to sample from directly under the cursor (Point 1x1) or from differently sized square areas where the color is averaged.

[](https://www.affinity.studio/help/tools-tools-clrpicker/#shortcuts)

## Shortcuts

Desktop app

*   To select the Color Picker Tool, press the **I** key.

[](https://www.affinity.studio/help/tools-tools-clrpicker/#see-also:)

#### SEE ALSO:

*   [Sampling colors](https://www.affinity.studio/help/clr-sampling-clr/)
