---
title: "Erase From Source Image Mask Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-erase-from-source-image/
slug: tools-tools-erase-from-source-image
fetched: 2026-08-06
---

# Erase From Source Image Mask Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-erase-from-source-image/

[Skip to main content](https://www.affinity.studio/help/tools-tools-erase-from-source-image/#_r_0_)
...
2.   Erase From Source Image Mask Tool

# Erase From Source Image Mask Tool

The Erase From Source Image Mask Tool

![Image 4](https://images.ctfassets.net/3p2fxa94bzao/1JePHOcZPgb6CwwmJi5c2b/14ccdc5a1fa7208f58fb9d35b264b302/eraser_tool.svg)

 allows you to manually remove previously added overlapping areas from the individual stitched images in your panorama.

[](https://www.affinity.studio/help/tools-tools-erase-from-source-image/#where-to-find-it)

### Where to find it

The Erase From Source Image Mask Tool is available only in **Panorama Studio**.

Tool shortcut key: **U**.

[](https://www.affinity.studio/help/tools-tools-erase-from-source-image/#about-the-erase-from-source-image-mask-tool)

## About the Erase From Source Image Mask Tool

When stitching your images, sometimes the initial rendering of the panorama may include areas that do not overlap appropriately. While you can add to the overlapping areas with the **Add To Source Image Mask Tool**, you may find that you've over-painted in the overlapping regions. This can be fixed by painting over those regions with the **Erase From Source Image Mask Tool**, which will use the original frame's data rather than referencing from the surrounding stacks.

[](https://www.affinity.studio/help/tools-tools-erase-from-source-image/#shortcuts)

## Shortcuts

Desktop app

*   Drag to automatically choose the best fitting source image in an overlapping region.

[](https://www.affinity.studio/help/tools-tools-erase-from-source-image/#see-also:)
