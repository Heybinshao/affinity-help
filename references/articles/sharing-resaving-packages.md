---
title: "Resaving modified packages - Affinity Help Center"
source: https://www.affinity.studio/help/sharing-resaving-packages/
slug: sharing-resaving-packages
fetched: 2026-08-06
---

# Resaving modified packages - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/sharing-resaving-packages/

[Skip to main content](https://www.affinity.studio/help/sharing-resaving-packages/#_r_0_)
...
3.   Resaving modified packages

# Resaving modified packages

After making changes to a document stored in [.afpackage file format](https://www.affinity.studio/help/sharing-about-packaging/), you need to choose the appropriate command for the next step of your workflow.

You can't save changes directly back to the package's file by selecting **Save** on the **File** menu. Choose one of the following:

*   **File > Save As**—to save as an .af file, which returns the document to the regular open/edit/save workflow. This is a good choice if you like to save often while working, or if changes may require multiple editing sessions.
*   **File > Save As Package**—to save as an .afpackage file. You can save in an empty folder to create a new package and leave the original unchanged, or to the original package's folder to update it. This is a good choice if changes can be completed quickly, in one editing session.

[](https://www.affinity.studio/help/sharing-resaving-packages/#how-to-resave-a-package)

### How to resave a package

Desktop app

After opening a package and editing the document:

1.   On the **File** menu, select **Save as Package**.
2.   Navigate to the folder containing the original package, then click **Package**.
3.   A dialog appears, warning that the folder is not empty. Choose one of the following: 
    ...
    *   **Cancel**—to abandon the packaging process, e.g. if you have decided to save as an .af file instead.

[](https://www.affinity.studio/help/sharing-resaving-packages/#see-also:)

#### SEE ALSO:

*   [About packaging](https://www.affinity.studio/help/sharing-about-packaging/)
*   [Creating packages](https://www.affinity.studio/help/sharing-creating-packages/)
*   [Opening packages](https://www.affinity.studio/help/sharing-opening-packages/)
