---
title: "Desktop settings: Photoshop Plugins - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-plugins/
slug: desktop-settings-plugins
fetched: 2026-08-06
---

# Desktop settings: Photoshop Plugins - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-plugins/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-plugins/#_r_0_)
...
2.   Desktop settings: Photoshop Plugins

# Desktop settings: Photoshop Plugins

Add, remove, and authorize Photoshop-compatible plugins, and control where the app searches for plugin and support files.

The following settings are available:

*   **Open Default Folder in Finder**(Mac) / **Open Default Folder in Explorer**(Windows)—Opens the folder that is searched for plugins in your operating system's file manager. Plugins can be added to this folder for easy access from the **Pixel > Filters**menu.
*   **Add/Remove Plugin Search Folder**—Adds or removes a folder in which to search or access support files to make plugins accessible from the **Pixel > Filters**menu.
...
[](https://www.affinity.studio/help/desktop-settings-plugins/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-plugins/#see-also:)

#### SEE ALSO:

*   [About Settings for desktop](https://www.affinity.studio/help/workspace-settings/)
*   [Settings: Software Update](https://www.affinity.studio/help/desktop-settings-software-update/)
