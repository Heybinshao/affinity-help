---
title: "Liquify Mesh Clone Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-liquify-mesh-clone/
slug: tools-tools-liquify-mesh-clone
fetched: 2026-08-06
---

# Liquify Mesh Clone Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-liquify-mesh-clone/

[Skip to main content](https://www.affinity.studio/help/tools-tools-liquify-mesh-clone/#_r_0_)
...
2.   Liquify Mesh Clone Tool

# Liquify Mesh Clone Tool

The Liquify Mesh Clone Tool

![Image 4](https://images.ctfassets.net/3p2fxa94bzao/6RF1xhioHoU79Y72PKUdPY/2945f19a0c926ea29f95351a4e2e8128/liquify_clone_mesh_tool.svg)

 samples from one part of the mesh onto another. It is ideal for applying previously set mesh adjustments to another area of the image.

[](https://www.affinity.studio/help/tools-tools-liquify-mesh-clone/#where-to-find-it)

### Where to find it

The Liquify Mesh Clone Tool is available only in **Liquify Studio**.

Tool shortcut key: **C**.

[](https://www.affinity.studio/help/tools-tools-liquify-mesh-clone/#options)
...
**⌥**-click (Mac) / **Alt**-click (Windows) sets the sample area.

Tool settings can be adjusted using the [Brushes panel](https://www.affinity.studio/help/panels-liquify-panel-brush/).

[](https://www.affinity.studio/help/tools-tools-liquify-mesh-clone/#shortcuts)
...
*   You can quickly decrease or increase the brush width using the **[** or **]** keys, respectively.
*   The **⇧** key (Mac) / **Shift** key (Windows) reduces the rate at which the warp effect is applied.

[](https://www.affinity.studio/help/tools-tools-liquify-mesh-clone/#see-also:)

#### SEE ALSO:

*   [Liquify Studio](https://www.affinity.studio/help/workspace-liquify-studio/)
