---
title: "Image layers - Affinity Help Center"
source: https://www.affinity.studio/help/layers-layer-image/
slug: layers-layer-image
fetched: 2026-08-06
---

# Image layers - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/layers-layer-image/

[Skip to main content](https://www.affinity.studio/help/layers-layer-image/#_r_0_)
...
Placed images will automatically be added to the Layers panel as an image layer. This includes files that are dragged and dropped onto the document, placed via the Place command, or by any other placement method.

![Image 4: Image layer](https://images.ctfassets.net/3p2fxa94bzao/3BawkkNHI81HCqIXmcfBKf/3e2d57084d55a18403f4d04500d2f7e7/layers_image.jpg)

A placed image.

Image layers retain all of the data from the original image, which remains intact when the document is exported.

An image layer is a container which retains the placed image's original color space, resolution and physical dimensions (when placed at native resolution).
...
When working on documents that use physical measurement units, it's useful to place images created at a set print size and resolution. In Affinity, you can do this using the Crop Tool (Resample mode), physical print dimensions (e.g. 6in x 4in) and a DPI suitable for pro print (e.g. 300).

[](https://www.affinity.studio/help/layers-layer-image/#how-to-convert-a-pixel-layer-to-an-image-layer)

### How to convert a pixel layer to an image layer

Desktop app

*   With a pixel layer selected, from the **Layer** menu, select **Convert > To Image Resource**.

[](https://www.affinity.studio/help/layers-layer-image/#to-convert-an-image-layer-to-a-pixel-layer--vector-studio-only-)

### To convert an image layer to a pixel layer (Vector Studio only)
...
*   On the **Pixel** menu, select **Rasterize > Rasterize**.

[](https://www.affinity.studio/help/layers-layer-image/#see-also:)
