---
title: "Select and view pages - Affinity Help Center"
source: https://www.affinity.studio/help/pages-selecting-viewing-pages/
slug: pages-selecting-viewing-pages
fetched: 2026-08-06
---

# Select and view pages - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/pages-selecting-viewing-pages/

[Skip to main content](https://www.affinity.studio/help/pages-selecting-viewing-pages/#_r_0_)
...
3.   Select and view pages

# Select and view pages

Selecting and viewing pages are essential operations which can be easily performed through the Pages panel.

Desktop app

![Image 4](https://images.ctfassets.net/3p2fxa94bzao/4L4feCdIpm3UfYMhByBXLV/5ea5574c878a83bc892b25bec660d49e/selectviewpages.jpg)

The Pages panel showing the active spread (gray border; Pages 2,3) and selected page (blue border; page 5).

[](https://www.affinity.studio/help/pages-selecting-viewing-pages/#selecting-pages)

## Selecting pages

Selecting a page, or multiple pages, allows you to apply actions or properties (e.g., **Apply Master**) to the selection.

Selected pages have a blue border around them on the **Pages** panel.

[](https://www.affinity.studio/help/pages-selecting-viewing-pages/#viewing-pages)

## Viewing pages

Making a page the current, active page shows it in the document view, and allows you to easily select and edit content on that page.

The active page has a gray border around it on the **Pages** panel.

[](https://www.affinity.studio/help/pages-selecting-viewing-pages/#how-to-select-a-page)
...
*    On the **Pages** panel: 
    *   Single page: Click on a page to select it.
    *   Multiple adjacent pages: Click on a page then **⇧**-click (Mac) / **Shift**-click (Windows) on another page to select those pages and all pages in between.
    *   Multiple non-adjacent pages: Click on a page then **⌘**-click (Mac) / **Ctrl**-click (Windows) on additional pages to add them to the selection.

You can select the left or right page of a spread, or both, depending on where you click on the spread's thumbnail.

[](https://www.affinity.studio/help/pages-selecting-viewing-pages/#how-to-view-a-page)

### How to view a page

Desktop app

*   On the **Pages** panel, double-click on a page. This makes it the active page and focuses on it in the document view.

[](https://www.affinity.studio/help/pages-selecting-viewing-pages/#see-also:)

#### SEE ALSO:

*   [Navigating pages](https://www.affinity.studio/help/pages-navigating-pages/)
