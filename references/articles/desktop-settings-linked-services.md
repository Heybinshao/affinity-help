---
title: "Desktop settings: Linked Services - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-linked-services/
slug: desktop-settings-linked-services
fetched: 2026-08-06
---

# Desktop settings: Linked Services - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-linked-services/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-linked-services/#_r_0_)
...
2.   Desktop settings: Linked Services

# Desktop settings: Linked Services

Connect Affinity to supported cloud storage services so linked resources remain accessible across devices.

The following settings are available:

*   **Linked Services**—Use these options if you use multiple personal devices to edit documents that contain linked resources from cloud storage. See the [Linked Services](https://www.affinity.studio/help/Media/linkedServices.html) topic.

[](https://www.affinity.studio/help/desktop-settings-linked-services/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-linked-services/#see-also:)

#### SEE ALSO:

*   [About Settings for desktop](https://www.affinity.studio/help/workspace-settings/)
*   [Settings: Photoshop Plugins](https://www.affinity.studio/help/desktop-settings-plugins/)
