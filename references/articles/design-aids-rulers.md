---
title: "Rulers - Affinity Help Center"
source: https://www.affinity.studio/help/design-aids-rulers/
slug: design-aids-rulers
fetched: 2026-08-06
---

# Rulers - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/design-aids-rulers/

[Skip to main content](https://www.affinity.studio/help/design-aids-rulers/#_r_0_)
...
Rulers are useful when you need to accurately place items or guides on the page or artboard.

![Image 4: Rulers](https://images.ctfassets.net/3p2fxa94bzao/6f0IN1R3L8upKJDiEN5AUt/29bae2020bc67a98ee6ac9a7374d9a13/rulers.png)

The intersection point where both vertical and horizontal rulers meet is called the spread origin, also known as the ruler origin. It's position is defined by X and Y coordinate values expressed in the current document units, e.g. 100px,100px.

[](https://www.affinity.studio/help/design-aids-rulers/#how-to-show-or-hide-rulers)

### How to show or hide rulers

Desktop app

*   On the **View** menu, select **Show > Rulers**.

[](https://www.affinity.studio/help/design-aids-rulers/#how-to-reposition-the-spread-origin)

### How to reposition the spread origin

Desktop app

*   Do one of the following: 
    *   Drag the spread origin from the default horizontal/vertical ruler intersection at the top left of your document view to position the spread origin on the page. If snapping has been activated, the spread origin will be able to snap to objects on the page.
    *   On the **View** menu, select **Margins and Guides**. Enter **X** and **Y** values into the **Spread Origin** section.

If you have placed ruler guides, their positional values will be recalculated based on the repositioned spread origin.

[](https://www.affinity.studio/help/design-aids-rulers/#how-to-reset-the-ruler-origin-to-default)

### How to reset the ruler origin to default

Desktop app

*   Double-click on the previously repositioned ruler intersection point.

[](https://www.affinity.studio/help/design-aids-rulers/#how-to-change-the-ruler-units)

### How to change the ruler units

Desktop app

*   **^(ctrl)**-click (Mac) / **right**-click (Windows) the ruler intersection and choose a unit type from the pop-up menu.

[](https://www.affinity.studio/help/design-aids-rulers/#see-also:)

#### SEE ALSO:

*   [Ruler and column guides](https://www.affinity.studio/help/design-aids-guides/)
