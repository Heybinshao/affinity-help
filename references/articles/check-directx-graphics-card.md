---
title: "How to check your graphics card is compatible with DirectX 10 - Affinity Help Center"
source: https://www.affinity.studio/help/check-directx-graphics-card/
slug: check-directx-graphics-card
fetched: 2026-08-06
---

# How to check your graphics card is compatible with DirectX 10 - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/check-directx-graphics-card/

[Skip to main content](https://www.affinity.studio/help/check-directx-graphics-card/#_r_0_)
...
3.   How to check your graphics card is compatible with DirectX 10

# How to check your graphics card is compatible with DirectX 10

Affinity apps require a DirectX-10-compatible graphics card or higher. To determine your graphics card's DirectX version, follow these steps:

1.   Press the**Windows** Key +**R**.
2.   Type "**dxdiag**" into the Run dialog and press OK.

This will open the DirectX Diagnostic Tool. Navigate to the **Display** tab and locate **Feature Levels** under the **Drivers** section. This will indicate the feature levels supported by your graphics card. If **10_0** or higher is listed, your card supports DirectX 10.
