---
title: "Typography panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-typography-panel/
slug: panels-typography-panel
fetched: 2026-08-06
---

# Typography panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-typography-panel/

[Skip to main content](https://www.affinity.studio/help/panels-typography-panel/#_r_0_)
...
[](https://www.affinity.studio/help/panels-typography-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **Text > Typography**.

[](https://www.affinity.studio/help/panels-typography-panel/#about-the-typography-panel)

## About the Typography panel

The **Typography** panel expands text formatting options by supporting OpenType font features, enabling a higher level of text customization. Available options depend on the font including the necessary glyphs.

[](https://www.affinity.studio/help/panels-typography-panel/#options)

## Options

The following options are available on the panel:

*   **Hide irrelevant features**—hides panel options that aren't relevant to the selected text.
...
*   **Swash**—applies any available ornate alternative glyph.
*   **Stylistic Sets**—applies any available, more decorative style substitutes to the selected text.
...
*   **Capitals**—applies options for how capital letters are presented in the selected text.
...
[](https://www.affinity.studio/help/panels-typography-panel/#see-also:)

#### SEE ALSO:

*   [Character formatting](https://www.affinity.studio/help/text-characters/)
*   [OpenType font features](https://www.affinity.studio/help/text-opentype-fonts/)
