---
title: "Where do I find crash reports for Affinity?  - Affinity Help Center"
source: https://www.affinity.studio/help/crash-report/
slug: crash-report
fetched: 2026-08-06
---

# Where do I find crash reports for Affinity?  - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/crash-report/

[Skip to main content](https://www.affinity.studio/help/crash-report/#_r_0_)
...
3.   Where do I find crash reports for Affinity? 

# Where do I find crash reports for Affinity?

Should the Affinity support team request a crash report, these instructions will guide you in locating them on both Windows and macOS. These reports are vital for our developers to investigate the issue and identify the cause of the crash.

[](https://www.affinity.studio/help/crash-report/#find-crash-reports-for-affinity)

### Find crash reports for Affinity

Desktop app

[](https://www.affinity.studio/help/crash-report/#windows)

#### **Windows**

1. Press the **Windows Key** + **R** to launch the **Run** dialog and enter the relevant app path:

*   **For MSIX version users:**

%USERPROFILE%\.affinity\Affinity\3.0\CrashReports\reports

*   **For MSI/EXE version users:**

%APPDATA%\Affinity\Affinity\3.0\CrashReports\reports

Crash reports are identified by a **.dmp** extension and consist of a filename with random alphanumeric characters.

[](https://www.affinity.studio/help/crash-report/#m)

#### M**acOS**

1.   Open the **Console** app from **Applications**>**Utilities**
2.   In the left-hand panel, select **Crash Reports**. A list of reports will appear.
3.   Identify the relevant crash report by looking for Affinity in the "Process Name" column.
4.   **Right-click** on the report and choose **Reveal in Finder**.
5.   Please send the resulting **.crash/.ips** file to the support team.

You can also access the file by navigating to **~/Library/Logs/DiagnosticReports** using Finder.

Please attach your crash report to your email reply to our support team or include it when submitting a new ticket through the Affinity Help Center.
