---
title: "Finding - Affinity Help Center"
source: https://www.affinity.studio/help/object-control-finding/
slug: object-control-finding
fetched: 2026-08-06
---

# Finding - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/object-control-finding/

[Skip to main content](https://www.affinity.studio/help/object-control-finding/#_r_0_)
...
In more complex documents, it's really useful to be able to locate an object in your layer stack as you select the object or layer on the page.

Two approaches to finding an item can be taken: either keep using the default Auto-scroll feature in the Layers panel or disable Auto-scroll or manually find it instead.

Whichever method you choose, the result is the same; the item's layer entry comes into view in the Layers panel ready for you to work on it.

You can also find objects and layers in groups, and groups themselves.

Layers can also be tagged with a color to make them easier to locate and organize via the Layers panel by right-clicking on the selected layer and picking from the choice of available colors.

[](https://www.affinity.studio/help/object-control-finding/#how-to-disable-auto-scroll)

### How to disable Auto-scroll

Desktop app

*   On the **Layers** panel, click **Panel Preferences**  ![Image 4](https://images.ctfassets.net/3p2fxa94bzao/6xHYQYa3ePyLnNbDC3c5Ey/56d26d75e40a2d195e578a41b2b16612/panel_preferences.svg)        and uncheck **Auto-scroll**.

[](https://www.affinity.studio/help/object-control-finding/#how-to-find-an-object-or-layer-in-the-layers-panel-manually)

### How to find an object or layer in the Layers panel manually

Desktop app

Do one of the following:

*   **^(ctrl)**-click (Mac) / **right**-click (Windows) the layer content on the page and select **Find in Layers Panel**. 
*   On the **Layer** menu, select **Find in Layers Panel**.
*   On your keyboard, press **⌘K** (Mac) / **Ctrl**+**K** (Windows). 

[](https://www.affinity.studio/help/object-control-finding/#see-also:)

#### SEE ALSO:

*   [Tagging layers](https://www.affinity.studio/help/layers-tag-layers/)
