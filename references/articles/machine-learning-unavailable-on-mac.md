---
title: "Why are the machine learning features unavailable on a supported Mac? - Affinity Help Center"
source: https://www.affinity.studio/help/machine-learning-unavailable-on-mac/
slug: machine-learning-unavailable-on-mac
fetched: 2026-08-06
---

# Why are the machine learning features unavailable on a supported Mac? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/machine-learning-unavailable-on-mac/

[Skip to main content](https://www.affinity.studio/help/machine-learning-unavailable-on-mac/#_r_0_)
...
3.   Why are the machine learning features unavailable on a supported Mac?

# Why are the machine learning features unavailable on a supported Mac?

Machine Learning features are not available on Intel-based Macs. As a result, the **Machine Learning Models** tab will not appear in Affinity Settings.

If you're using a Mac with an Apple silicon chip and macOS Ventura or later, but the Machine Learning Models tab is missing, check that Affinity is not running with Rosetta.

[](https://www.affinity.studio/help/machine-learning-unavailable-on-mac/#how-to-check-if-affinity-is-running-with-rosetta)

### How to check if Affinity is running with Rosetta

Desktop app

1.   Open your **Applications** folder.
2.   Right-click the **Affinity** app and choose **Get Info**.
3.   Make sure **Open using Rosetta** is turned off.

If **Open using Rosetta** is enabled, Machine Learning models will not be available in Affinity.
