---
title: "Zoom Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-zoom/
slug: tools-tools-zoom
fetched: 2026-08-06
---

# Zoom Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-zoom/

[Skip to main content](https://www.affinity.studio/help/tools-tools-zoom/#_r_0_)
...
![Image 4](https://images.ctfassets.net/3p2fxa94bzao/6jmWPErECQEdSLoFK86wRd/4df92fffdb8d65af90c0a607ed39cdb2/zoom_tool.svg)

 is used to change the zoom level of your page in the document view.

[](https://www.affinity.studio/help/tools-tools-zoom/#how-to-use-the-zoom-tool:)
...
2.   Click on the page to zoom in.
3.   (Optional) On the context toolbar, adjust **Zoom**to set a specific zoom level.
4.   (Optional) Use the zoom slider to zoom in or out of the document.
5.   (Optional) From the **Units**pop-up menu, choose the measurement units used for the document view.
6.   Continue zooming until the area you want to inspect or edit is visible.

[](https://www.affinity.studio/help/tools-tools-zoom/#options)

### Options

The following options can be adjusted from the context toolbar:

*   **Zoom**—sets a zoom level. Select from the pop-up menu or drag the slider to adjust the zoom level.
*   **Units**—sets a unit of measurement. Select from the pop-up menu.

[](https://www.affinity.studio/help/tools-tools-zoom/#settings)

## Settings

Related behaviors can be adjusted from the app's settings:

*   **Tools > Use 'scrubby' zoom**—choose whether dragging with the Zoom Tool zooms around the cursor (scrubby zoom) or creates a 'zoom to' marquee.

[](https://www.affinity.studio/help/tools-tools-zoom/#shortcuts)

## Shortcuts

Desktop app

*   To select the Zoom Tool, press the **Z** key.
*   To zoom in or out by an arbitrary amount, drag left or right.
*   Hold **⌥**(Mac) / **Alt**(Windows) and click to zoom out.
*   To set the zoom level to 100%, where document pixels map directly to screen pixels, double-click on the Zoom Tool's icon.

[](https://www.affinity.studio/help/tools-tools-zoom/#see-also:)

#### SEE ALSO:

*   [Zooming](https://www.affinity.studio/help/design-aids-zoom/)
