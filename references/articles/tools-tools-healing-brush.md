---
title: "Healing Brush Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-healing-brush/
slug: tools-tools-healing-brush
fetched: 2026-08-06
---

# Healing Brush Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-healing-brush/
...
![Image 1](https://images.ctfassets.net/3p2fxa94bzao/3S7TRAmOosle6WPuWsIzT8/8776a022b9d607cddc9c940dfca08498/healing_brush_tool.svg)

 enables you to repair and retouch unsightly areas of an image. It conveniently remembers last-used settings.

The Healing Brush Tool is available by default in Pixel Studio, on the Inpainting Brush Tool's flyout.

It can be added to other Studios. See 'Customizing tools' for details.

The Healing Brush Tool does not have a default keyboard shortcut, but you can assign one manually if desired. See [Customizing keyboard shortcuts](https://www.affinity.studio/help/workspace-customizing-shortcuts/) for details.

The tool can clone from other images (called Global Sources) using the [Sources panel](https://www.affinity.studio/help/panels-sources-panel/).
...
*   ![Image 10](https://images.ctfassets.net/3p2fxa94bzao/2svOpxCTQtuZS531qQI10e/9c1258d352f17d58bf6beb44c66449c5/aligned.svg) **Aligned**—when selected, the origin of the sample remains a fixed distance from the pointer. If this option is off, the origin of the sample always returns to the sample location defined initially.
*   **Source**—the source determines the layer(s) from which the pixels are sampled. Select from the pop-up menu.
*   ![Image 11](https://images.ctfassets.net/3p2fxa94bzao/23KckJCXRxlLbsm2LBA38c/5ae5e79fcb9a6d3e50df74bfa4e8461e/add_global_source.svg) **Add Global Source**—sets the currently defined sample origin as a global source for use in other images. Remember to select a source using **⌥**-click (Mac) / **Alt**-click (Windows) first. 
*   ![Image 12](https://images.ctfassets.net/3p2fxa94bzao/3WhxupTfhFgTPOi2Cq10DP/7875afb205755ff608969ea9d0476a87/slider_rotation.svg) **Rotation**—sets the degree of rotation applied to the sample. The result can be previewed inside the brush cursor. Type directly in the text box or drag the pop-up slider to set the value.
*   ![Image 13](https://images.ctfassets.net/3p2fxa94bzao/YtIstAJxagUs6S0hV3kMs/9be82fc1107efe1926df3622571773f7/scale.png) **Scale**—sets the scale of the sample between 1% and 1000%. Type directly in the text box or drag the pop-up slider to set the value. The result can be previewed inside the brush cursor.
...
*   To select the Healing Brush Tool, press the **J** key. This key cycles through related tools.
*   To adjust the **Rotation** setting, use the left and right arrow keys.
*   To adjust the **Scale** setting, use the up and down arrow keys.
