---
title: "Text frame setup - Affinity Help Center"
source: https://www.affinity.studio/help/text-frame-setup/
slug: text-frame-setup
fetched: 2026-08-06
---

# Text frame setup - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/text-frame-setup/

[Skip to main content](https://www.affinity.studio/help/text-frame-setup/#_r_0_)
...
To set the way text flows through a frame and the frame's appearance, use the Text Frame panel.

![Image 4: Frame setups](https://images.ctfassets.net/3p2fxa94bzao/5jele7vMKDnwMXKxbGM4WX/4ace0ab79fd9de51e49df4c3b58322ef/frame_setup.jpg)
...
[](https://www.affinity.studio/help/text-frame-setup/#about-frame-setups)

## About frame setups

A text frame's frame setup can be configured on the **Text Frame** panel, where you can set:

*   the frame's stroke color, fill color, and insets on each side.
*   the number of columns through which text flows.
*   column and gutter widths, which can be irregular.
*   vertical alignment of text.
*   rules (strokes) between columns.
*   behaviors with respect to other objects.
*   an independent baseline grid, meaning specific to an individual frame.

A text frame's number of columns can also be set on the **Frame Text Tool**'s context toolbar.

Affinity reuses the last applied frame settings for new text frames, unless you first revert the Frame Text Tool to [default settings](https://www.affinity.studio/help/object-control-object-defaults/).

If you autoflow text to additional text frames, the newly created frames adopt the initial text frame's setup.

Each frame's setup is independent. Editing any selected text frame changes only that frame.

[](https://www.affinity.studio/help/text-frame-setup/#reusing-text-frame-setups)

## Reusing text frame setups

Text frame setups can be copied and pasted from a source text frame to one or more selected target text frames.

Any text frame setup can be saved as an [asset](https://www.affinity.studio/help/assets-assets/)—for example, to a custom subcategory such as _My Text Frames_.

[](https://www.affinity.studio/help/text-frame-setup/#how-to-change-a-selected-text-frame-s-setup)

### How to change a selected text frame's setup

Desktop app

1.   On the **Window** menu, select **Text > Text Frame**.
2.   On the panel that appears, use the various sections to configure the frame's setup.

[](https://www.affinity.studio/help/text-frame-setup/#how-to-copy-and-paste-a-text-frame-s-setup)

### How to copy and paste a text frame's setup
...
4.   On the **Edit** menu, select **Paste > Style**.

[](https://www.affinity.studio/help/text-frame-setup/#see-also:)
...
*   [Text Frame panel](https://www.affinity.studio/help/panels-text-frame-panel/)
*   [Assets](https://www.affinity.studio/help/assets-assets/)
*   [Object defaults](https://www.affinity.studio/help/object-control-object-defaults/)
