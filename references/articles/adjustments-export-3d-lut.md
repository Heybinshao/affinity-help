---
title: "Exporting custom adjustments as LUTs - Affinity Help Center"
source: https://www.affinity.studio/help/adjustments-export-3d-lut/
slug: adjustments-export-3d-lut
fetched: 2026-08-06
---

# Exporting custom adjustments as LUTs - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/adjustments-export-3d-lut/

[Skip to main content](https://www.affinity.studio/help/adjustments-export-3d-lut/#_r_0_)
...
3.   Exporting custom adjustments as LUTs

# Exporting custom adjustments as LUTs

You can create your own LUTs based on the adjustments applied to a project for future use or distribution.

Only top level adjustments are considered when exporting LUTs. Any that are children of layers are ignored. Similarly, any custom set Blend Ranges are also omitted upon a LUT export.

[](https://www.affinity.studio/help/adjustments-export-3d-lut/#settings)

### Settings

Desktop app

*   **Title**—sets the descriptive name of the adjustment.
*   **Format**—sets the exported file type. Select from the pop-up menu.
*   **Quality**—sets the complexity of the exported adjustment. Drag the slider to set the value.

The following types of LUT files are available: ***.3dl**, ***.csp**, ***.cube**, and ***.look**.

[](https://www.affinity.studio/help/adjustments-export-3d-lut/#how-to-export-as-a-lut)

### How to export as a LUT

Desktop app

1.   Apply one or more adjustments to your project.
2.   On the **File** menu, select **Export > LUT**.
3.   Adjust the settings in the dialog.
4.   Click **Export**.
5.   Navigate to and select storage folder, name the file, and then click **Export**.

[](https://www.affinity.studio/help/adjustments-export-3d-lut/#see-also:)
