---
title: "Stock panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-stock-panel/
slug: panels-stock-panel
fetched: 2026-08-06
---

# Stock panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-stock-panel/

[Skip to main content](https://www.affinity.studio/help/panels-stock-panel/#_r_0_)
...
Use the Stock panel to access content from several photo providers directly from within Affinity.

[](https://www.affinity.studio/help/panels-stock-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **Layout > Stock**.

[](https://www.affinity.studio/help/panels-stock-panel/#about-the-stock-panel)

## About the Stock panel

You can search by keyword, browse image thumbnails, and drag them to the page to add them to your document.

[](https://www.affinity.studio/help/panels-stock-panel/#options)
...
*   **Archive**—sets the photo provider whose content will be searched and shown on the panel. Select from the pop-up menu.
*   **Search**—type in the box to display images tagged with matching terms. Click the cross to remove the search term and image results.
*   **Vector**—when checked, the search is limited to just vector artwork. (Only available for Pixabay.)
...
[](https://www.affinity.studio/help/panels-stock-panel/#see-also:)

#### SEE ALSO:

*   [Using stock photos](https://www.affinity.studio/help/media-stock-photos/)
