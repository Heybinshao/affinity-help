---
title: "Font Manager panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-font-manager-panel/
slug: panels-font-manager-panel
fetched: 2026-08-06
---

# Font Manager panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-font-manager-panel/

[Skip to main content](https://www.affinity.studio/help/panels-font-manager-panel/#_r_0_)
...
3.   Font Manager panel

# Font Manager panel

The Font Manager panel lets you review fonts used in a document and includes options for managing missing or incomplete fonts.

For a guide to using this panel, see the "Managing fonts" topic.

[](https://www.affinity.studio/help/panels-font-manager-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Document** menu, select **Font Manager**. On desktop, Resource Manager is a regular window; it cannot be docked like a panel, but can be kept open while you continue to work in the app.

[](https://www.affinity.studio/help/panels-font-manager-panel/#options)

## Options

The following options are available on the window/panel:

Desktop app

*   **Font list**—All the fonts used in your document. For each entry, the following information is displayed: 
    *   **Name**—A font's family and style.
    *   **Status**—The status of the font: _OK_, _Missing_ or _Unsupported characters used_.
    *   **Substitution**—When the expected font is unavailable, the font family that is being used as a substitute is shown. A substitute is chosen for you, but you can select a different one.
    *   **Substitution Style**—When a font has been substituted, the font style that is being used is shown. Like the font family, you can select a different style.

 Click the Name or Status column header to sort the list by that attribute. 
*   **Locate**—Focuses the document view on a page on which the font is applied and selects the text. Repeated use cycles through additional instances.

[](https://www.affinity.studio/help/panels-font-manager-panel/#see-also:)
