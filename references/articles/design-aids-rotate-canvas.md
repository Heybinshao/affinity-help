---
title: "Rotate document view - Affinity Help Center"
source: https://www.affinity.studio/help/design-aids-rotate-canvas/
slug: design-aids-rotate-canvas
fetched: 2026-08-06
---

# Rotate document view - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/design-aids-rotate-canvas/

[Skip to main content](https://www.affinity.studio/help/design-aids-rotate-canvas/#_r_0_)
...
![Image 4: Rotated document view](https://images.ctfassets.net/3p2fxa94bzao/5sDgXEggoJOUwJeVVbZwLi/eaba1a3bbe8bf7d48381c4f5ec7eecee/rotate_document_view.png)

[](https://www.affinity.studio/help/design-aids-rotate-canvas/#about-document-view-rotation)

## About document view rotation

Being able to rotate the document view is beneficial for a number of applications:

*   For painting and fine detail work
...
If you wish to permanently rotate the canvas, altering your content:

*   On the **Document** menu, select **Rotate 90° Clockwise** or **Rotate 90° Counter-clockwise**.

[](https://www.affinity.studio/help/design-aids-rotate-canvas/#how-to-rotate-the-document-view)

### How to rotate the document view

Desktop app

*   On the _View_ menu, select _Rotate > Left_ or _Rotate > Right_. The document view will be rotated in 15° increments.

[](https://www.affinity.studio/help/design-aids-rotate-canvas/#how-to-reset-the-document-view-back-to-its-original-rotation)

### How to reset the document view back to its original rotation
...
*   For Mac: Press **⌃(ctrl)⇧⌘R**.
*   For Windows: Press **Ctrl**+**Alt**+**Shift**+**R**.

For greater efficiency, assign your own custom keyboard shortcuts to rotating and resetting document view operations.

[](https://www.affinity.studio/help/design-aids-rotate-canvas/#how-to-switch-on-document-view-rotation-using-a-scroll-wheel)

### How to switch on document view rotation using a scroll wheel

Desktop app

Do one of the following from _Settings_ (Tools option):

*   For Mac: Check **Enable canvas rotation with ⌘+scroll wheel**.
*   For Windows: Check **Enable canvas rotation with Alt-click+scroll wheel**.

Desktop app

[](https://www.affinity.studio/help/design-aids-rotate-canvas/#shortcuts)

### Shortcuts

With the above setting enabled, the following modifier keys can be used to modify rotation behavior using a mouse scroll wheel:

*    For Mac: Hold down the **⌘** key while scrolling to rotate around the mouse cursor location. 
*    For Windows: Hold down the **Alt** key while scrolling to rotate around the mouse cursor location. 
*    For Windows: To rotate about the document view center, hold down the **Shift**+**Alt** keys while scrolling. 

[](https://www.affinity.studio/help/design-aids-rotate-canvas/#see-also:)
...
*   [Keyboard shortcuts for the workspace](https://www.affinity.studio/help/workspace-shortcuts-workspace/)
