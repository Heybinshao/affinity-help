---
title: "Why am I getting the error 'Sideloading is blocked by policy' when trying to install Affinity on Windows? - Affinity Help Center"
source: https://www.affinity.studio/help/sideloading-error/
slug: sideloading-error
fetched: 2026-08-06
---

# Why am I getting the error "Sideloading is blocked by policy" when trying to install Affinity on Windows? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/sideloading-error/

[Skip to main content](https://www.affinity.studio/help/sideloading-error/#_r_0_)
...
2.   ... 
3.   Why am I getting the error "Sideloading is blocked by policy" when trying to install Affinity on Windows? 

# Why am I getting the error "Sideloading is blocked by policy" when trying to install Affinity on Windows?

When installing Affinity on Windows, you might see the error "**Sideloading is blocked by policy. Contact your administrator to allow you to install apps from anywhere.**" To resolve this, you'll need to modify the following settings.

[](https://www.affinity.studio/help/sideloading-error/#how-to-fix--sideloading-is-blocked-by-policy--on-windows)

### How to Fix “Sideloading is Blocked by Policy” on Windows

Windows app

1.   Navigate to **Settings.**
2.   Select **Apps**>**Advanced App Settings**.
3.   From the **Choose where to get apps** dropdown menu, select **Anywhere**.
4.   Once this change is made, try installing Affinity again.

If your computer is managed by an administrator (e.g., a work computer), Group Policy may control this setting. In this situation, you will need to contact your administrator for help.
