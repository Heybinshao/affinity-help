---
title: "Snapshot layers - Affinity Help Center"
source: https://www.affinity.studio/help/layers-layer-snapshot/
slug: layers-layer-snapshot
fetched: 2026-08-06
---

# Snapshot layers - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/layers-layer-snapshot/

[Skip to main content](https://www.affinity.studio/help/layers-layer-snapshot/#_r_0_)
...
[](https://www.affinity.studio/help/layers-layer-snapshot/#how-to-create-a-snapshot-layer)

### How to create a snapshot layer

Desktop app

*   On the **Layer** menu, select a snapshot from the **New Layer from Snapshot** submenu.The snapshot layer is added above the current layer (or at the top of the Layers panel if no layer is selected).

[](https://www.affinity.studio/help/layers-layer-snapshot/#see-also:)

#### SEE ALSO:

*   [Using snapshots](https://www.affinity.studio/help/design-aids-snapshot/)
