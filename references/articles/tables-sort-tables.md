---
title: "Sorting tables - Affinity Help Center"
source: https://www.affinity.studio/help/tables-sort-tables/
slug: tables-sort-tables
fetched: 2026-08-06
---

# Sorting tables - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tables-sort-tables/

[Skip to main content](https://www.affinity.studio/help/tables-sort-tables/#_r_0_)
...
Tables can be sorted to rearrange their columns or rows to suit your needs.

![Image 4: Contextual options for a table column](https://images.ctfassets.net/3p2fxa94bzao/4y9yytqNaKHTn9JKzgSQdL/9afa948f7c2695f5ebbec623bfee783b/tables_02.jpg)

Sorting options are accessed via the column or row's header.

For example, you might alphabetize list entries or arrange data in numerical order.

[](https://www.affinity.studio/help/tables-sort-tables/#how-to-sort-table-rows-or-columns)

### How to sort table rows or columns

Desktop app

1.   Make an insertion point in the table.
2.   Hover over the header of the row or column you want to sort, then click the arrow that appears.
3.   On the menu that appears, select **Sort Ascending** or **Sort Descending** to sort the table by the values in the chosen row or column.

[](https://www.affinity.studio/help/tables-sort-tables/#see-also:)

#### SEE ALSO:

*   [Table Tool](https://www.affinity.studio/help/tools-tools-table/)
*   [Creating tables](https://www.affinity.studio/help/tables-create-tables/)
