---
title: "Which RAW files do Affinity support? - Affinity Help Center"
source: https://www.affinity.studio/help/supported-raw-files/
slug: supported-raw-files
fetched: 2026-08-06
---

# Which RAW files do Affinity support? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/supported-raw-files/

[Skip to main content](https://www.affinity.studio/help/supported-raw-files/#_r_0_)
...
3.   Which RAW files do Affinity support?

# Which RAW files do Affinity support?
...
On macOS, an alternative option is to utilise the built-in RAW image processing capabilities of the Apple (Core Image RAW) engine. For a list of supported models, please consult the relevant articles:

*   on [macOS Sequoia](https://support.apple.com/120534)
*   on [macOS Sonoma](https://support.apple.com/105094)
*   on [macOS Ventura](https://support.apple.com/101627)
*   on [macOS Monterey](https://support.apple.com/103234)
*   on [macOS Big Sur](https://support.apple.com/106350)
*   on [macOS Catalina](https://support.apple.com/101186)

The SerifLabs RAW engine utilises:

1.   [Libraw](https://www.libraw.org/news/libraw-0-21-3-release) with additional changes
2.   Nikon HE decoding using a library supplied by Nikon
3.   Canon CR3 code supplied by Canon

**Lists of Serif Labs Raw Engine Supported Cameras:**

*   [Camera brands from A-G](https://www.affinity.studio/help/supported-raw-files-1/)
*   [Camera brands from H-N](https://www.affinity.studio/help/supported-raw-files-2/)
*   [Camera brands from O-Z](https://www.affinity.studio/help/supported-raw-files-3/)
