---
title: "Quick Export  - Affinity Help Center"
source: https://www.affinity.studio/help/sharing-quick-export/
slug: sharing-quick-export
fetched: 2026-08-06
---

# Quick Export  - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/sharing-quick-export/

[Skip to main content](https://www.affinity.studio/help/sharing-quick-export/#_r_0_)
...
Use Quick Export to quickly save your design without navigating through detailed export options.

[](https://www.affinity.studio/help/sharing-quick-export/#about-quick-export)

## About Quick Export

The Quick Export feature lets you quickly save your design using predefined export presets. Affinity includes a variety of presets covering common file formats, sizes, resampling methods, and naming conventions, allowing you to export efficiently without extensive configuration. If needed, you can also create and add your own custom presets to suit specific workflows.

Quick Export lets you easily specify the destination folder—including the **To Canva** option—so your exported files are immediately accessible exactly where you need them.

After editing settings on the dialog, you can simply drag the preview to another app, such as an email or a messaging app.

[](https://www.affinity.studio/help/sharing-quick-export/#how-to-use-quick-export)

### How to use Quick Export

Desktop app

1.   Go to the top-right corner of the interface and click the down arrow to expand the Quick Export dialog.
2.   Choose your Quick Export options. (See the [Quick Export panel](https://www.affinity.studio/help/panels-quick-export-panel/) topic for details).
3.   Click **Export**.

[](https://www.affinity.studio/help/sharing-quick-export/#see-also:)

#### SEE ALSO:

*   [About exporting](https://www.affinity.studio/help/sharing-export/)
*   [Quick Export panel](https://www.affinity.studio/help/panels-quick-export-panel/)
