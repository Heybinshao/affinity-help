---
title: "Change or reset password  - Affinity Help Center"
source: https://www.affinity.studio/help/change-password/
slug: change-password
fetched: 2026-08-06
---

# Change or reset password  - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/change-password/

[Skip to main content](https://www.affinity.studio/help/change-password/#_r_0_)
...
If you need to reset your password for security, this guide will show you how. You’ll learn how to reset a forgotten password or change your current one in just a few steps.

We recommend considering setting up a [passkey](https://www.canva.com/help/passkey-log-in). This adds an extra layer of security to your account and makes logging in easier and faster.

[](https://www.affinity.studio/help/change-password/#change-your-password)

## Change your password

Quick tip

Change your password now from Settings.

[Open Settings](https://www.canva.cn/settings/login-and-security)

Here’s how to change your password:

1.   On the homepage, select your profile icon to open the menu.
2.   Select**Settings**.
3.   Go to the [**Login**](https://www.canva.com/settings/login-and-security)tab.
4.   Next to **Password**, select **Update**.
5.   Enter your current password for verification purposes.
6.   Enter your new password. Try making it at least **8 characters** long. Learn more about [protecting your account](https://www.canva.com/help/protect-account).
7.   Re-enter it under **Confirm new password**.
8.   Click **Save changes**.

A password change confirmation will be sent to your [account email](https://www.canva.com/help/change-email).

[](https://www.affinity.studio/help/change-password/#reset-your-password)
...
[Yes, reset my password](https://www.canva.com/login/reset)

1.   Go to the [password reset](https://www.canva.com/login/reset/) page.
2.   Enter your account email, and select **Continue**.
3.   Check your email inbox for the code we’ve sent. Enter the code and select **Continue**.
4.   Enter a new password. Try making it at least **8 characters** long. Learn more about [protecting your account](https://www.canva.com/help/protect-account).
5.   In **Confirm new password**, re-enter your new password to confirm.
6.   Select the **Set password**button to finish.
