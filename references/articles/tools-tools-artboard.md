---
title: "Artboard Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-artboard/
slug: tools-tools-artboard
fetched: 2026-08-06
---

# Artboard Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-artboard/

[Skip to main content](https://www.affinity.studio/help/tools-tools-artboard/#_r_0_)
...
![Image 4](https://images.ctfassets.net/3p2fxa94bzao/1U3kNff9CwQe3qKLyzLv1J/1f2c24b9a5a241682428987ae3a4ab34/artboard_tool.svg)

 allows you to add, move and resize [artboards](https://www.affinity.studio/help/artboards-artboards-about/) within a document.

[](https://www.affinity.studio/help/tools-tools-artboard/#where-to-find-it)

### Where to find it

The Artboard Tool is available by default in Vector Studio.

It can be added to other Studios. See 'Customizing tools' for details.

You can assign a custom shortcut in Affinity's settings. See [Customizing keyboard shortcuts](https://www.affinity.studio/help/workspace-customizing-shortcuts/) for details.

New artboards can be "cloned" from existing artboards and will be placed according to the **Spacing** on the context toolbar. The context toolbar distance is also used to help snapping decisions when moving an artboard near another artboard.

[](https://www.affinity.studio/help/tools-tools-artboard/#settings)
...
*   **W**—sets the custom width of the new artboard.
*   **H**—sets the custom height of the new artboard.
*   **Spacing**—sets the spacing between the new artboard and existing artboards.
*   **Insert Artboard**—adds a new artboard to the pasteboard.

[](https://www.affinity.studio/help/tools-tools-artboard/#shortcuts)

## Shortcuts

Desktop app

*   The Artboard Tool has no keyboard shortcut by default, but one can be assigned via the app's settings.

[](https://www.affinity.studio/help/tools-tools-artboard/#see-also:)
