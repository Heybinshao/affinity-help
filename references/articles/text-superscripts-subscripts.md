---
title: "Using superscripts and subscripts - Affinity Help Center"
source: https://www.affinity.studio/help/text-superscripts-subscripts/
slug: text-superscripts-subscripts
fetched: 2026-08-06
---

# Using superscripts and subscripts - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/text-superscripts-subscripts/

[Skip to main content](https://www.affinity.studio/help/text-superscripts-subscripts/#_r_0_)
...
3.   Using superscripts and subscripts

# Using superscripts and subscripts

You can raise or lower characters relative to the baseline by applying the superscript or subscript option.

Affinity can use a font's proper superscript or subscript glyphs where available.

If the font doesn't include superscript or subscript glyphs, Affinity uses a faux effect that scales and repositions the characters.

[](https://www.affinity.studio/help/text-superscripts-subscripts/#how-to-use-a-font-s-proper-superscripts-and-subscripts)

### How to use a font's proper superscripts and subscripts

Desktop app

On the **Typography** panel:

*   In the **Figure Position** section, select **Superscript** or **Subscript**. These options appear only if the selected font contains the corresponding glyphs.

[](https://www.affinity.studio/help/text-superscripts-subscripts/#how-to-use-faux-superscripts-and-subscripts)

### How to use faux superscripts and subscripts

Desktop app

On the **Character** panel:

*   In the **Position & Transform** section, set **Super/Subscript**  ![Image 4](https://images.ctfassets.net/3p2fxa94bzao/nh6kiJMJBRegqMJrd4XMR/42aca8f23dad13d16eaacef999bd37c0/super_subscript.svg)        as needed.

[](https://www.affinity.studio/help/text-superscripts-subscripts/#see-also:)

#### SEE ALSO:

*   [Character formatting](https://www.affinity.studio/help/text-characters/)
*   [Character panel](https://www.affinity.studio/help/panels-character-panel/)
*   [Typography panel](https://www.affinity.studio/help/panels-typography-panel/)
