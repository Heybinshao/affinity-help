---
title: "Place Tool - Affinity Help Center"
source: https://www.affinity.studio/help/tools-tools-placeimage/
slug: tools-tools-placeimage
fetched: 2026-08-06
---

# Place Tool - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/tools-tools-placeimage/

[Skip to main content](https://www.affinity.studio/help/tools-tools-placeimage/#_r_0_)
...
![Image 4](https://images.ctfassets.net/3p2fxa94bzao/47Z9iHInfnQl0IelWGJTdH/a235b375a151ad38f5a59edbf4183bba/place_image_tool.svg)

 adds an image or document to your page at its default or custom dimensions.

[](https://www.affinity.studio/help/tools-tools-placeimage/#where-to-find-it)

### Where to find it

The Place Tool is available by default in Layout Studio.

It can be added to other Studios. See 'Customizing tools' for details.

The Place Image Tool does not have a default keyboard shortcut, but you can assign one manually if desired. See [Customizing keyboard shortcuts](https://www.affinity.studio/help/workspace-customizing-shortcuts/) for details.

[](https://www.affinity.studio/help/tools-tools-placeimage/#shortcuts)

## Shortcuts

Desktop app

*   The Place Tool has no keyboard shortcut by default, but one can be assigned via the app's settings.

[](https://www.affinity.studio/help/tools-tools-placeimage/#see-also:)
