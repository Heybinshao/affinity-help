---
title: "Differences between x64 and ARM64 on Windows - Affinity Help Center"
source: https://www.affinity.studio/help/differences-between-x64-and-arm64/
slug: differences-between-x64-and-arm64
fetched: 2026-08-06
---

# Differences between x64 and ARM64 on Windows - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/differences-between-x64-and-arm64/

[Skip to main content](https://www.affinity.studio/help/differences-between-x64-and-arm64/#_r_0_)
...
3.   Differences between x64 and ARM64 on Windows

# Differences between x64 and ARM64 on Windows

Affinity is compatible with both x64 and ARM64 machines.

[](https://www.affinity.studio/help/differences-between-x64-and-arm64/#x64-architecture)

### **x64 Architecture**

This refers to 64-bit architecture used in machines with an x64 Intel/AMD CPU and an x64 version of Windows.

[](https://www.affinity.studio/help/differences-between-x64-and-arm64/#arm64-architecture)

### **ARM64 Architecture**

This refers to 64-bit architecture used in machines with an x64 ARM CPU and an x64 version of Windows.

_Please note: Affinity is not compatible with x32 (32-bit) CPUs and Windows._

[](https://www.affinity.studio/help/differences-between-x64-and-arm64/#how-to-determine-if-your-windows-pc-uses-intel-amd-or-arm)

### How to Determine If Your Windows PC Uses Intel/AMD or ARM
