---
title: "Mask panel (Liquify Studio) - Affinity Help Center"
source: https://www.affinity.studio/help/panels-liquify-panel-mask/
slug: panels-liquify-panel-mask
fetched: 2026-08-06
---

# Mask panel (Liquify Studio) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-liquify-panel-mask/

[Skip to main content](https://www.affinity.studio/help/panels-liquify-panel-mask/#_r_0_)
...
3.   Mask panel (Liquify Studio)

# Mask panel (Liquify Studio)

When warping an image in the Liquify Studio, you can protect certain areas from distortion by masking them. The Mask panel provides commands for managing that mask.

This feature is only available in Affinity for desktop.

[](https://www.affinity.studio/help/panels-liquify-panel-mask/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **Mask**.

[](https://www.affinity.studio/help/panels-liquify-panel-mask/#options)

## Options

The following options are available on the panel:

*   **Clear Mask**—removes the current mask from the image.
*   **Mask All**—applies a mask to the entire image.
*   **Invert Mask**—reverses the mask settings so all areas which are not masked become masked and vice versa. Opacity values of masked pixels are also inverted.
...
[](https://www.affinity.studio/help/panels-liquify-panel-mask/#see-also:)
