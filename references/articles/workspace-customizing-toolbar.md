---
title: "Customizing the Toolbar - Affinity Help Center"
source: https://www.affinity.studio/help/workspace-customizing-toolbar/
slug: workspace-customizing-toolbar
fetched: 2026-08-06
---

# Customizing the Toolbar - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/workspace-customizing-toolbar/

[Skip to main content](https://www.affinity.studio/help/workspace-customizing-toolbar/#_r_0_)
...
The Toolbar organizes some of the most commonly used commands and functions in each Studio to keep them at your fingertips. The Toolbar can be customized to fit your individual way of working.

This feature is only available in Affinity for desktop.

[](https://www.affinity.studio/help/workspace-customizing-toolbar/#how-to-show-hide-tool-group-labels-on-the-toolbar)

### How to show/hide tool group labels on the Toolbar

Desktop app

1.   On the **View** menu, select **Customize Toolbar**.
2.   From the dialog's **Show** pop-up menu, select **Icon Only** or **Icon and Text**.

[](https://www.affinity.studio/help/workspace-customizing-toolbar/#how-to-hide-show-the-toolbar)

### How to hide/show the Toolbar

Desktop app

*   On the **View** menu, select **Show > Toolbar**.

[](https://www.affinity.studio/help/workspace-customizing-toolbar/#how-to-customize-the-toolbar)
...
3.   Remove items by dragging them off the Toolbar and onto your document view.

[](https://www.affinity.studio/help/workspace-customizing-toolbar/#how-to-save-your-toolbar-arrangement-as-a-preset)

### How to save your Toolbar arrangement as a preset

Desktop app

*   On the **Window** menu, select **Panels > Add Preset**.

For future selection, the named preset you save will be shown in the same submenu as the above command.

[](https://www.affinity.studio/help/workspace-customizing-toolbar/#how-to-reset-the-toolbar)

### How to reset the Toolbar

Desktop app

1.   On the **View** menu, select **Customize Toolbar**.
2.   Drag the **default set** item to the Toolbar. This will revert the Toolbar back to its original settings (removing any custom buttons).

[](https://www.affinity.studio/help/workspace-customizing-toolbar/#see-also:)
