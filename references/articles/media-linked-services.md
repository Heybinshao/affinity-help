---
title: "Linked Services - Affinity Help Center"
source: https://www.affinity.studio/help/media-linked-services/
slug: media-linked-services
fetched: 2026-08-06
---

# Linked Services - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/media-linked-services/

[Skip to main content](https://www.affinity.studio/help/media-linked-services/#_r_0_)
...
Affinity's Linked Services feature makes it easy to work with linked resources stored in Dropbox and iCloud Drive across devices.

[](https://www.affinity.studio/help/media-linked-services/#why-linked-services-is-useful)

## Why Linked Services is useful

The path to a linked resource stored in Dropbox or iCloud Drive can be broken down into two parts. For example:

**/Users/Affinity/Dropbox**/_Affinity Projects/Flyer/Resources/image.tiff_

The emboldened part is the path to the resource within cloud storage and is the same on all devices.

The italicised part is the path to the folder to which cloud storage is synced. It may differ between devices, e.g. because user accounts have different names or because Dropbox is configured to sync to a different drive, which can lead to missing resource warnings.

Normally, Affinity stores the full path to any linked resource. With Linked Services, the device-specific part is replaced by a placeholder for the relevant cloud storage provider, and only the part of the path within the cloud storage is stored. The earlier example would then be stored as:

Dropbox:/Affinity Projects/Flyer/Resources/image.tiff

Affinity automatically replaces the prefixed reference with the path to cloud storage on the device that is currently in use.

[](https://www.affinity.studio/help/media-linked-services/#icloud-drive)

## iCloud Drive

The benefits of Linked Services are automatic for linked resources in iCloud Drive. Your device needs to be signed into iCloud Drive via Apple's system settings (Mac) or iCloud app (Windows).

[](https://www.affinity.studio/help/media-linked-services/#dropbox)

## Dropbox

You will need to install Dropbox's software and sign into the same account on each of your devices. You'll then need to link Affinity to Dropbox on each device.

[](https://www.affinity.studio/help/media-linked-services/#how-to-link-affinity-to-your-dropbox-account)

### How to link Affinity to your Dropbox account

Desktop app

1.   Do one of the following: 
    *   For Mac: On the **Affinity** menu, select **Settings**.
    *   For Windows: On the **Edit** menu, select **App Settings**.

2.   On the dialog that appears: 
    1.   Select **Linked Services**.
    2.   Next to Dropbox, click **Link**.
    3.   The Dropbox site opens in your default browser. Follow its instructions to link your Dropbox account to Affinity. At the end of the process, you will be returned to Affinity.

[](https://www.affinity.studio/help/media-linked-services/#how-to-unlink-affinity-from-your-dropbox-account)

### How to unlink Affinity from your Dropbox account
...
2.   On the dialog that appears: 
    1.   Select **Linked Services**.
    2.   Next to Dropbox, click **Unlink**.

[](https://www.affinity.studio/help/media-linked-services/#see-also:)

#### SEE ALSO:

*   [Placing content](https://www.affinity.studio/help/media-place-images/)
*   [Managing document resources](https://www.affinity.studio/help/media-resource-manager/)
