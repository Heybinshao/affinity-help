---
title: "Auto filters - Affinity Help Center"
source: https://www.affinity.studio/help/filters-filter-auto/
slug: filters-filter-auto
fetched: 2026-08-06
---

# Auto filters - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/filters-filter-auto/

[Skip to main content](https://www.affinity.studio/help/filters-filter-auto/#_r_0_)
...
Auto filters are useful automatic filters that affect tone, color and white balance in your image. Results may vary, so it's worth experimenting with different images a little.

[](https://www.affinity.studio/help/filters-filter-auto/#about-the-auto-filters)

## About the Auto filters

Desktop app

The filters can be found on the **Pixel > Filters > Colors** menu. They include:

*   **Auto Levels**—a simplified version of the Levels function that assigns a new "top" and "bottom" to the tonal range, making the darkest image pixel black and the lightest one white, and spreading out the in-between pixels over a wide tonal range. Auto Levels performs this adjustment separately for each of the Red, Green, and Blue channels, while Auto Contrast operates on the image as a whole.
*   **Auto Contrast**—applies a contrast adjustment automatically which stretches or clips the tonal range on all channels.
*   **Auto Colors**—applies a cross-channel color shift that subtly boosts saturation.
*   **Auto White Balance**—infers a white point calculated from the whole of the image and adjusts the white balance accordingly.

[](https://www.affinity.studio/help/filters-filter-auto/#settings)

### Settings

There are no configurable settings available with these filters.

[](https://www.affinity.studio/help/filters-filter-auto/#see-also:)
