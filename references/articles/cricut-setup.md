---
title: "Use Affinity with Cricut cutting machines - Affinity Help Center"
source: https://www.affinity.studio/help/cricut-setup/
slug: cricut-setup
fetched: 2026-08-06
---

# Use Affinity with Cricut cutting machines - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/cricut-setup/

[Skip to main content](https://www.affinity.studio/help/cricut-setup/#_r_0_)
...
3.   Use Affinity with Cricut cutting machines

# Use Affinity with Cricut cutting machines

Setting up your document correctly is essential for seamless import into the Cricut Design Space app.

Here are some key considerations when using Affinity with Cricut cutting machines, keep the following in mind:

*   **DPI Setting:** Your document should be set to 72 DPI.
*   **Layer Management:** Cricut Design Space reorders all layers to optimize material usage. To maintain the original layout of multiple Curve Layers, merge them into a single Curve Layer. Select all Curve Layers and navigate to **Vector**>**Merge Curves**.
*   **Padding:** Cricut Design Space moves all layers to the edge of the material for efficient cutting. If you need to add padding around your design, insert a Rectangle Layer around your Curve Layers before merging them.
*   **Export Settings:** Export your design as an SVG. Crucially, in the 'Advanced' options, _uncheck_ '**SetViewBox**' to preserve the design's correct size.

If, after following these steps, your design still doesn't appear correctly in the Cricut Design Space app, we suggest opening the exported SVG in another application to confirm its appearance. If it displays as expected there, this indicates a potential issue with the Cricut Design Space app itself. In such cases, please reach out to[Cricut's support team](https://help.cricut.com/) for further help.
