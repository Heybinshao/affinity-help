---
title: "About books - Affinity Help Center"
source: https://www.affinity.studio/help/advanced-about-books/
slug: advanced-about-books
fetched: 2026-08-06
---

# About books - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/advanced-about-books/

[Skip to main content](https://www.affinity.studio/help/advanced-about-books/#_r_0_)
...
A book lets you combine several Affinity documents into one publication, so you can edit and export them together. Books are created and managed on the Books panel.

This feature is only available in Affinity for desktop.

The **Books** panel shows your book's structure and lets you:

*   Add Affinity (.af) documents as chapters.
*   Reorder chapters as needed.
*   Keep page, list and note numbers in sync.
*   Apply styles from your 'style source' chapter to the others.
*   Control how single (stray) pages between chapters are handled.
*   Check for preflight errors before output.
*   Export or print some or all chapters.

[](https://www.affinity.studio/help/advanced-about-books/#see-also:)

#### SEE ALSO:

*   [Creating books](https://www.affinity.studio/help/advanced-creating-books/)
*   [Synchronizing chapters](https://www.affinity.studio/help/advanced-syncing-chapters/)
*   [Updating page, list and note numbers](https://www.affinity.studio/help/advanced-updating-numbers/)
*   [Outputting books](https://www.affinity.studio/help/advanced-outputting-books/)
