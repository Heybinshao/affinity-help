---
title: "Interface Visual Reference - Affinity Help Center"
source: https://www.affinity.studio/help/workspace-interface/
slug: workspace-interface
fetched: 2026-08-06
---

# Interface Visual Reference - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/workspace-interface/

[Skip to main content](https://www.affinity.studio/help/workspace-interface/#_r_0_)
...
3.   Interface Visual Reference

# Interface Visual Reference

Here's a quick visual overview of the key areas of the user interface in Affinity. A good understanding of these will help interpret procedures in the main topics.

![Image 4: Affinity Visual Reference](https://images.ctfassets.net/3p2fxa94bzao/3HCFnqnptZrexfIAGpH0Aa/acab7644db6b11ac2af8cb299873be4f/visualreference.png)

Affinity user interface (English app example)

[](https://www.affinity.studio/help/workspace-interface/#heading--a--toolbar)

## (A) Toolbar

This contains commonly used functions including design aids. Its contents change depending on the active Studio and can be customized.

Toolbar options include:

*   (B) **Studios**—these are workspaces for various design disciplines and tasks.
*   (C) **Operations and design aids**—this area hosts frequently used options that change depending on the active Studio.
*   (D) **Export**—set up your preferred export file formats so you can quickly generate output files.

[](https://www.affinity.studio/help/workspace-interface/#heading--e--context-toolbar)

## (E) Context Toolbar

This floating toolbar presents options for the currently selected tool. The tool options and settings change depending on the tool selected.

[](https://www.affinity.studio/help/workspace-interface/#heading--f--tools-panel)

## (F) Tools Panel

Gives access to various tools for editing. The tools change based on the Studio that is selected. The contents can be customized.

[](https://www.affinity.studio/help/workspace-interface/#heading--g--right-panel-group)

## (G) Right panel group

Various panels providing essential functionality for controlling settings. They may differ between Studios and can be undocked and hidden/switched on via the Window menu.

[](https://www.affinity.studio/help/workspace-interface/#heading--h--document-view)

## (H) Document view

The area that displays your current document. If you are using artboards, it will display them surrounded by a pasteboard.

[](https://www.affinity.studio/help/workspace-interface/#heading--i--status-bar)

## (I) Status bar

Displays tool hints and available keyboard modifiers for the selected tool.

[](https://www.affinity.studio/help/workspace-interface/#heading--j--menu-bar)

## (J) Menu bar

The menu bar shows commands organized into logical groupings.

[](https://www.affinity.studio/help/workspace-interface/#see-also:)

#### SEE ALSO:

*   [Toolbar](https://www.affinity.studio/help/workspace-toolbar/)
