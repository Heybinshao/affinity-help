---
title: "Opening documents and images - Affinity Help Center"
source: https://www.affinity.studio/help/get-started-open-document/
slug: get-started-open-document
fetched: 2026-08-06
---

# Opening documents and images - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/get-started-open-document/

[Skip to main content](https://www.affinity.studio/help/get-started-open-document/#_r_0_)
...
3.   Opening documents and images

# Opening documents and images

As well as opening previously saved Affinity documents, raster images (from camera, mobile device, or digital artwork) and vector images (SVGs) can be opened.
...
[](https://www.affinity.studio/help/get-started-open-document/#how-to-open-a-document-or-image)

### How to open a document or image
...
[](https://www.affinity.studio/help/get-started-open-document/#how-to-open-a-recently-used-document)

### How to open a recently used document

Desktop app

*   On the **File** menu, click **Open Recent**, then select a file from the submenu.

You can locate or remove recently used project files right from the **Recents** section of the Welcome screen's Home page. **^(ctrl)**-click (Mac) / **right**-click (Windows) the file preview and select an option.

[](https://www.affinity.studio/help/get-started-open-document/#how-to-open-an-image-by-drag-and-drop)

### How to open an image by drag and drop

Desktop app

Do one of the following:

*   For Mac: Open Finder and drag the file to an off-page area of your workspace.
*   For Windows: Open File Explorer and drag the file to an off-page area of your workspace.

Raster images opened using the above method will create a new document with one layer, named 'Background', which is [locked](https://www.affinity.studio/help/object-control-locking/) by default. The document will adopt the image name as its file name.

[](https://www.affinity.studio/help/get-started-open-document/#settings)
...
*   **General > Reopen document(s) on startup**
*   **Color > Convert opened files to working space**.
*   **User Interface > Default View Mode**

[](https://www.affinity.studio/help/get-started-open-document/#see-also:)
