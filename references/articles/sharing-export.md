---
title: "About exporting - Affinity Help Center"
source: https://www.affinity.studio/help/sharing-export/
slug: sharing-export
fetched: 2026-08-06
---

# About exporting - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/sharing-export/

[Skip to main content](https://www.affinity.studio/help/sharing-export/#_r_0_)
...
Affinity has three methods of exporting your work to external files, such as PNG, TIFF, and PDF: the Quick Export panel, the Export dialog, and the Slice Studio. You can use whichever method suits your needs.

*   The **Quick Export** panel is a streamlined way to export all or part of your document to one of your favorite file formats or to Canva. The output is affected by the preset you select and key settings on the panel.
*   The **Export** dialog is for exporting your work, in whole or in part, to one file. It differs from Quick Export in that it gives you access to all file formats and export settings.
*   The **Slice Studio** is for exporting your work, in whole or in part, to multiple files. You can choose the file format and preset used for each output.

[](https://www.affinity.studio/help/sharing-export/#about-the-quick-export-panel)

### About the Quick Export panel

The Quick Export panel lets you select one of Affinity's presets or a custom preset you've created using the Export dialog.

You can also set the dimensions, resampling method, and scale of the output.

[](https://www.affinity.studio/help/sharing-export/#about-the-export-dialog)

### About the Export dialog

The Export dialog offers access to all supported file formats and full control over export settings. The app comes with built-in presets for quick access to standard export settings for common use cases. Alternatively, you can specify your own export settings and create your own presets for them.

The dialog shows a preview of what will be exported. You can zoom and pan the preview to see how your settings affect the output. Resize the dialog to see more of your document.

The dialog also shows an estimated file size based on your choices.

You can use built-in and custom presets in Quick Export and the Slice Studio too.

[](https://www.affinity.studio/help/sharing-export/#about-the-slice-studio)

### About the Slice Studio

The Slice Studio lets you specify which parts of your work to export as different files, and the file format, filename, scale, and other settings to use for each.

To use the Slice Studio, you'll need to enable it. Its panels and tools can also be added to _any_ Studio—for example, you could add them to the Vector Studio and work entirely there if you prefer.

[](https://www.affinity.studio/help/sharing-export/#see-also:)

#### SEE ALSO:

*   [Quick Export](https://www.affinity.studio/help/sharing-quick-export/)
*   [Export dialog](https://www.affinity.studio/help/sharing-export-dialog/)
*   [Slice Studio](https://www.affinity.studio/help/sharing-slice-studio/)
*   [Export to Canva](https://www.affinity.studio/help/sharing-export-to-canva/)
