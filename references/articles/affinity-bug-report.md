---
title: "Report bugs to the Affinity team  - Affinity Help Center"
source: https://www.affinity.studio/help/affinity-bug-report/
slug: affinity-bug-report
fetched: 2026-08-06
---

# Report bugs to the Affinity team  - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/affinity-bug-report/

[Skip to main content](https://www.affinity.studio/help/affinity-bug-report/#_r_0_)
...
3.   Report bugs to the Affinity team 

# Report bugs to the Affinity team

Should you encounter what appears to be a bug, please submit a bug report via the Affinity application, providing as much detail as possible.
...
*   **Accurate description of the problem:** Clearly explain the issue you encountered.
*   **Step-by-step reproduction instructions:** Provide precise steps for us to replicate the bug.
*   **Supporting materials:** Include screenshots, screen recordings, or crash reports - these are highly beneficial for replicating the issue.

You can also attach the current document you have open in the application and include useful information about your computer.
