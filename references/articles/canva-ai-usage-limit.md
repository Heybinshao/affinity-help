---
title: "How does the AI usage limit work? - Affinity Help Center"
source: https://www.affinity.studio/help/canva-ai-usage-limit/
slug: canva-ai-usage-limit
fetched: 2026-08-06
---

# How does the AI usage limit work? - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/canva-ai-usage-limit/

[Skip to main content](https://www.affinity.studio/help/canva-ai-usage-limit/#_r_0_)
...
2.   How does the AI usage limit work?

# How does the AI usage limit work?

Your AI usage is pooled across Affinity and Canva premium AI tools and refreshes each month. You can use your balance however you like, from generating images and vectors in Affinity to creating videos or exploring new ideas in Canva.

[](https://www.affinity.studio/help/canva-ai-usage-limit/#about-canva-ai-usage-limit)

## About Canva AI usage limit

If your available credits are depleted and you attempt to use a feature that requires credits, the action can still be completed; however, processing may take longer than usual. After repeated use under these conditions, you may be prompted to upgrade to a higher-tier plan, such as Business or Enterprise for access to a higher credit allowance and faster processing.

To learn more about how your AI usage limit works and how to check the current remaining credits status, visit the [Understanding your AI allowance](https://www.canva.com/help/ai-access/) topic in the Canva Help Centre.

[](https://www.affinity.studio/help/canva-ai-usage-limit/#see-also:)
