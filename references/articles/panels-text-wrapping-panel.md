---
title: "Text Wrapping panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-text-wrapping-panel/
slug: panels-text-wrapping-panel
fetched: 2026-08-06
---

# Text Wrapping panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-text-wrapping-panel/

[Skip to main content](https://www.affinity.studio/help/panels-text-wrapping-panel/#_r_0_)
...
3.   Text Wrapping panel

# Text Wrapping panel

Use text wrapping to control how frame text flows around objects that partially or fully overlap it.

[](https://www.affinity.studio/help/panels-text-wrapping-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: Use the Toolbar's text wrap options. See [Text wrapping](https://www.affinity.studio/help/text-wrap-text/) for more details.

[](https://www.affinity.studio/help/panels-text-wrapping-panel/#about-text-wrapping)

## About text wrapping

Text can wrap around placed images, picture frames, shapes, or even other text frames that would otherwise overlap it.

You can apply common text wrap behaviours quickly, or take full control of the text wrap outline that determines how text flows around an object.

Text wrap settings are applied to the object you want frame text to flow around—not the text frame itself. The exception is when your layout requires one text frame's content to wrap around another.

[](https://www.affinity.studio/help/panels-text-wrapping-panel/#options)

## Options

Desktop app

On desktop, text wrapping is applied via the **Text** menu. The following options are available under **Text Wrap**:

*   **Show Text Wrap Settings**—opens a dialog where you can choose from common wrap behaviours (such as Jump, Square, and Tight). You can decide whether text wraps around the object's largest side or both sides, and the minimum distance text can be from each side of the wrap outline.
*   **Edit Wrap Outline**—shows a series of nodes around the edge of the selected object. Drag nodes to customise how text flows around the object. Click on the path to add nodes so you can fine-tune the wrap outline.
*   **Reset Wrap Outline**—removes any nodes you've added to the selected object's wrap outline and returns the default nodes to their usual positions around the object.
*   **Ignore Text Wraps**—sets the selected text frame to not reflow its contents around other objects. For example, you may want your text to be partially covered by an object in front of it as a deliberate part of your design.

One-click shortcuts for the first three options can also be added to the Toolbar by customizing it.

[](https://www.affinity.studio/help/panels-text-wrapping-panel/#see-also:)

#### SEE ALSO:

*   [Frame text](https://www.affinity.studio/help/text-frame-text/)
*   [Text wrapping](https://www.affinity.studio/help/text-wrap-text/)
