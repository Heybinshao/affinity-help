---
title: "Scanning images (Pixel Studio, Mac only) - Affinity Help Center"
source: https://www.affinity.studio/help/media-scanning-images/
slug: media-scanning-images
fetched: 2026-08-06
---

# Scanning images (Pixel Studio, Mac only) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/media-scanning-images/

[Skip to main content](https://www.affinity.studio/help/media-scanning-images/#_r_0_)
...
3.   Scanning images (Pixel Studio, Mac only)

# Scanning images (Pixel Studio, Mac only)

You can scan printed images directly into your project.

Your scanner needs to be correctly installed in macOS to allow it to be used in Affinity. You can check the scanner is installed by opening Apple's System Settings app, then selecting **Printers & Scanners**.

[](https://www.affinity.studio/help/media-scanning-images/#how-to-scan-an-image)
...
2.   On the **File** menu, select **New Image Process > Acquire Image**.
3.   On the dialog that appears: 
    1.   Make sure your scanner is shown and selected on the left.
    2.   Do one of the following: 
        *   Click **Scan** for a scan without acquiring a low-resolution Overview scan as a preview.
        *   Click **Show Details** to acquire an automatic Overview scan, make sure the settings are as needed, then click **Scan** for a full scan. Remember to set a high **Resolution** (>300dpi) for your full scan.

Your scanned image appears as an 'Untitled' document.

When scanning your files, Affinity lets you choose the **Default tone curve**for the process. The options can be found in **Settings > Assistant > Develop Assistant**.

If you're prompted to "Please select area to scan", click **Show Details**, then drag a selection area over the area you want to scan.

The dialog remains open to allow you to continue scanning additional images.

[](https://www.affinity.studio/help/media-scanning-images/#see-also)
