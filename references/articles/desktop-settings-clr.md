---
title: "Desktop settings: Color - Affinity Help Center"
source: https://www.affinity.studio/help/desktop-settings-clr/
slug: desktop-settings-clr
fetched: 2026-08-06
---

# Desktop settings: Color - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/desktop-settings-clr/

[Skip to main content](https://www.affinity.studio/help/desktop-settings-clr/#_r_0_)
...
2.   Desktop settings: Color

# Desktop settings: Color

Choose default color profiles, control HDR display behavior, and determine how color conversions and EXR data are handled.

The following settings are available:

*   **Color Profile**—You can set up your default RGB, 32-bit RGB, CMYK, Grayscale and LAB color profiles for use in future documents.
*   **Rendering Intent**—choose the rendering intent for your images.

[](https://www.affinity.studio/help/desktop-settings-clr/#opencolorio)
...
*   **Enable EDR by default in 32-bit RGB views**(Mac)/**Enable HDR by default in 32-bit RGB views**(Windows)—Choose whether to allow extended/high dynamic range images to be displayed in 32-bit RGB mode.
*   **OpenColorIO Configuration File**—Select a OpenColorIO Configuration File.
*   **OpenColorIO Search Folder**—(For Mac) Select a OpenColorIO Search Folder.
...
[](https://www.affinity.studio/help/desktop-settings-clr/#exr)
...
[](https://www.affinity.studio/help/desktop-settings-clr/#how-to-open-settings)
...
[](https://www.affinity.studio/help/desktop-settings-clr/#see-also:)

#### SEE ALSO:

*   [About Settings for desktop](https://www.affinity.studio/help/workspace-settings/)
*   [Settings: Performance](https://www.affinity.studio/help/desktop-settings-performance/)
