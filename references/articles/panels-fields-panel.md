---
title: "Fields panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-fields-panel/
slug: panels-fields-panel
fetched: 2026-08-06
---

# Fields panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-fields-panel/

[Skip to main content](https://www.affinity.studio/help/panels-fields-panel/#_r_0_)
...
Use the Fields panel to insert, view, and format metadata that automatically updates in your document text.

[](https://www.affinity.studio/help/panels-fields-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **References > Fields**.

[](https://www.affinity.studio/help/panels-fields-panel/#about-fields)

## About fields

The **Fields** panel lets you view key document information and change how fields are formatted.

[](https://www.affinity.studio/help/panels-fields-panel/#options)
...
*   **Document Sections**—displays the following section metadata: **Name**, **Running Header**, **Page Number**, **Last Page**, and **Run Last Page**.
*   **Continuation**—displays the **Previous Frame** and **Next Frame** page numbers.
...
*   **Data Merge (****_data source file name_****)**—dynamically displays fields from a currently connected external data source.
...
[](https://www.affinity.studio/help/panels-fields-panel/#see-also:)
...
*   [Data merge](https://www.affinity.studio/help/advanced-data-merge/) (Desktop only)
