---
title: "Using fonts - Affinity Help Center"
source: https://www.affinity.studio/help/addons-using-fonts/
slug: addons-using-fonts
fetched: 2026-08-06
---

# Using fonts - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/addons-using-fonts/

[Skip to main content](https://www.affinity.studio/help/addons-using-fonts/#_r_0_)
...
Affinity supports modern font file formats, including OpenType features such as ligatures, alternates, and stylistic sets. It also lets you use OpenType fonts containing SVG-based glyphs and color palettes.

[](https://www.affinity.studio/help/addons-using-fonts/#supported-font-file-formats)

## Supported font file formats

Affinity supports the same fonts as your operating system, such as OpenType and TrueType fonts.

Install fonts using your operating system or third-party font manager. If fonts are unavailable in Affinity, confirm in your font management tool that they are installed and enabled, then quit and reopen Affinity.

[](https://www.affinity.studio/help/addons-using-fonts/#about-affinity-s-font-manager)

## About Affinity's Font Manager

Affinity includes a feature called Font Manager for managing the fonts used in the current document. It indicates the status of each font, alerting you when any fonts are missing or do not support characters used in your text.

Font Manager _is not_ used to install fonts on your device. To install fonts, use the font management tools provided by your operating system or a third-party app.

[](https://www.affinity.studio/help/addons-using-fonts/#see-also:)
