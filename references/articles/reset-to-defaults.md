---
title: "Reset app to its default - Affinity Help Center"
source: https://www.affinity.studio/help/reset-to-defaults/
slug: reset-to-defaults
fetched: 2026-08-06
---

# Reset app to its default - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/reset-to-defaults/

[Skip to main content](https://www.affinity.studio/help/reset-to-defaults/#_r_0_)
...
3.   Reset app to its default

# Reset app to its default

You may occasionally need to reset the app to its default settings. This can be useful for troubleshooting unusual behavior within the Affinity app.

[](https://www.affinity.studio/help/reset-to-defaults/#reset-app-to-default-settings)

### Reset app to default settings

Desktop app

1.   To reset the app to its default settings, launch the app while holding down the **CTRL** key. 
2.   The **Clear User Data**window will appear, presenting a series of toggle switches.
3.   By default, the first three options, **Clear User Defaults**, **Reset Document & Windows States**, and **Reset Studio,** will be pre-selected.
4.   You can choose to enable or disable these and other options as needed.
5.   To revert the app to its initial settings, click "**Select All**" to choose all available options.

Resetting the app to its default settings will permanently delete all imported or created brushes, assets, macros, and presets. We strongly advise exporting these items before proceeding with the reset if you intend to use them again in the application.
