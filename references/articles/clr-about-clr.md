---
title: "About color - Affinity Help Center"
source: https://www.affinity.studio/help/clr-about-clr/
slug: clr-about-clr
fetched: 2026-08-06
---

# About color - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/clr-about-clr/

[Skip to main content](https://www.affinity.studio/help/clr-about-clr/#_r_0_)
...
Affinity can use different color models to represent different ways of describing color. These models (RGB, CMYK, LAB and Grey) can be selected as you create your new document.
...
In terms of selecting color as you design, Affinity provides the **Color** panel's HSL color wheel by default or optional sets of sliders. Furthermore, color swatches can be used on various panels and context toolbars to apply color; panels offer easy access to preset and custom 'saved' colors that you'd like to use again.
...
[](https://www.affinity.studio/help/clr-about-clr/#see-also:)

#### SEE ALSO:

*   [Color models](https://www.affinity.studio/help/clr-clr-models/)
*   [About color spaces](https://www.affinity.studio/help/clr-clr-spaces/)
