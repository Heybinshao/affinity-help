---
title: "Ask panel - Affinity Help Center"
source: https://www.affinity.studio/help/panels-ask-ritson-panel/
slug: panels-ask-ritson-panel
fetched: 2026-08-06
---

# Ask panel - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-ask-ritson-panel/

[Skip to main content](https://www.affinity.studio/help/panels-ask-ritson-panel/#_r_0_)
...
Quickly find accurate answers to your questions with the AI-powered Ask panel.

[](https://www.affinity.studio/help/panels-ask-ritson-panel/#where-to-find-it)

### Where to find it

For Mac/Windows: Click **Help**

![Image 3](https://images.ctfassets.net/3p2fxa94bzao/16DTvRWsQV9gmG5DbOFjNJ/38978d3688ee369e73a342dd185efad7/ask_ritson.svg)

 at the top-right of the user interface.

[](https://www.affinity.studio/help/panels-ask-ritson-panel/#about-ask)

## About Ask

The Ask panel is designed to help you quickly find solutions to questions and issues about navigating the app, completing edits, organizing project assets, collaborating with team members, customizing layouts, building successful workflows, and more.

Powered by AI and trained on the Affinity Help Center, it delivers accurate, relevant guidance so you can create and refine your projects without leaving your workspace.

[](https://www.affinity.studio/help/panels-ask-ritson-panel/#options)
...
*   **Ask**—allows you to enter the search term manually.
*   **Suggest a feature or improvement**—allows you to provide feedback regarding a feature or how the app can be made better overall.
*   **Report a bug**—allows you to contribute in listing a broken feature.
...
*   **Restart Chat**—erases previously searched items and starts a new support response.
...
[](https://www.affinity.studio/help/panels-ask-ritson-panel/#see-also:)

#### SEE ALSO:

*   [Canva AI & Affinity Machine Learning (ML)](https://www.affinity.studio/help/canva-ai-canva-ai-affinity-ml/)
