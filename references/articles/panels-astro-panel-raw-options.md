---
title: "RAW Options panel (Astrophotography Stack Studio) - Affinity Help Center"
source: https://www.affinity.studio/help/panels-astro-panel-raw-options/
slug: panels-astro-panel-raw-options
fetched: 2026-08-06
---

# RAW Options panel (Astrophotography Stack Studio) - Affinity Help Center

> 官方来源：https://www.affinity.studio/help/panels-astro-panel-raw-options/

[Skip to main content](https://www.affinity.studio/help/panels-astro-panel-raw-options/#_r_0_)
...
4.   RAW Options panel (Astrophotography Stack Studio)

# RAW Options panel (Astrophotography Stack Studio)
...
[](https://www.affinity.studio/help/panels-astro-panel-raw-options/#where-to-find-it)

### Where to find it

For Mac/Windows: On the **Window** menu, select **RAW Options**.

[](https://www.affinity.studio/help/panels-astro-panel-raw-options/#options)
...
*   **Demosaic Method**—can be either: 
    *   **Default**—the same method used by the **Develop Studio**.
...
[](https://www.affinity.studio/help/panels-astro-panel-raw-options/#see-also:)
